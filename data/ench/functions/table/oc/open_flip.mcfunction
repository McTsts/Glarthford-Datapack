...
data merge entity @e[tag=etPage1,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:8}}]}
...
execute if score $t2 enchOpen > $e1 enchOpen unless score $t2 enchOpen > $e2 enchOpen run data merge entity @e[tag=etPage1,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:10}}]}


scoreboard players operation $t enchOpen += $p1 enchOpen
scoreboard players operation $t enchOpen -= $p2 enchOpen
function ench:table/oc/calc_t2b
data merge entity @e[tag=etPage2,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:9}}]}
...
execute if score $t2 enchOpen > $e1 enchOpen unless score $t2 enchOpen > $e2 enchOpen run data merge entity @e[tag=etPage2,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:10}}]}

scoreboard players operation $t enchOpen += $p2 enchOpen
scoreboard players operation $t enchOpen -= $p3 enchOpen
function ench:table/oc/calc_t2
data merge entity @e[tag=etPage3,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:8}}]}
...
execute if score $t2 enchOpen > $e1 enchOpen unless score $t2 enchOpen > $e2 enchOpen run data merge entity @e[tag=etPage3,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:10}}]}

scoreboard players operation $t enchOpen += $p3 enchOpen
scoreboard players operation $t enchOpen -= $p4 enchOpen
function ench:table/oc/calc_t2b
data merge entity @e[tag=etPage4,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:9}}]}
...
execute if score $t2 enchOpen > $e1 enchOpen unless score $t2 enchOpen > $e2 enchOpen run data merge entity @e[tag=etPage4,limit=1,sort=nearest] {ArmorItems:[{},{},{},{id:"book",Count:1,tag:{CustomModelData:10}}]}