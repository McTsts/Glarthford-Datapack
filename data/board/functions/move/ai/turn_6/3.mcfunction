#
data modify storage board_ai boardM.RAM set from storage board_ai boardM.Move6_3
summon armor_stand 8 7 8 {Tags:["Move6_3","b_learn","new"],NoGravity:1b}
...
execute if entity @e[tag=RAM,tag=blue] run scoreboard players set B3 b_stats 2
