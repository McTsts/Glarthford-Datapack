#
data modify storage board_ai boardM.RAM set from storage board_ai boardM.Move6_9
summon armor_stand 8 7 8 {Tags:["Move6_9","b_learn","new"],NoGravity:1b}
...
execute if entity @e[tag=RAM,tag=orange] run scoreboard players set B6 b_stats 2
