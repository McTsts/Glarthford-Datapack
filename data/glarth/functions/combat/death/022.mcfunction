...
execute at @s unless entity @e[tag=tbcEnderPriestTiny,distance=0.1..] as @e[tag=tbcEnemy1,type=armor_stand] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=468]
