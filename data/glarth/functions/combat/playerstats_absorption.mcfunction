execute if score @s tbcAbsorption matches 1..4 unless score @s tbcAbsorptionX matches 1 run effect give @s minecraft:absorption 999999 0 true
...
execute if score @s tbcAbsorption matches 5..8 unless score @s tbcAbsorptionX matches 2 run effect give @s minecraft:absorption 999999 1 true
...
execute if score @s tbcAbsorption matches 9..12 unless score @s tbcAbsorptionX matches 3 run effect give @s minecraft:absorption 999999 2 true
...
execute if score @s tbcAbsorption matches 13..16 unless score @s tbcAbsorptionX matches 4 run effect give @s minecraft:absorption 999999 3 true
...
execute if score @s tbcAbsorption matches 17..20 unless score @s tbcAbsorptionX matches 5 run effect give @s minecraft:absorption 999999 4 true
