...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 5.. as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=45.01..135] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[90f,0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcThrowable"]}
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 5.. as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=-134.99..-45] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[-90f,0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcThrowable"]}
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 5.. as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=-44.99..45] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[0f,0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcThrowable"]}
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 5.. as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=135.01..-135] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[180f,0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcThrowable"]}
