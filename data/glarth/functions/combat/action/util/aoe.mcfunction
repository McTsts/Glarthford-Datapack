...
tellraw @a ["",[{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@s","interpret":true}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.aoe","with":[{"nbt":"out","storage":"ntca:io","interpret":true,"color":"red"}]}]
