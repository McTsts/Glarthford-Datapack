...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 2 run function glarth:combat/action/breakfree_item
...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.0 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.1 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.2 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.3 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.4 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.5 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.6 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.7 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run replaceitem entity @s hotbar.8 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 0 tbcBreakfree matches 1 run replaceitem entity @s hotbar.0 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 1 tbcBreakfree matches 1 run replaceitem entity @s hotbar.1 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 2 tbcBreakfree matches 1 run replaceitem entity @s hotbar.2 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 3 tbcBreakfree matches 1 run replaceitem entity @s hotbar.3 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 4 tbcBreakfree matches 1 run replaceitem entity @s hotbar.4 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 5 tbcBreakfree matches 1 run replaceitem entity @s hotbar.5 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 6 tbcBreakfree matches 1 run replaceitem entity @s hotbar.6 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 7 tbcBreakfree matches 1 run replaceitem entity @s hotbar.7 nether_star
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 8 tbcBreakfree matches 1 run replaceitem entity @s hotbar.8 nether_star
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 1 if score 0 tbcBreakfree matches 1 run replaceitem entity @s hotbar.0 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 2 if score 1 tbcBreakfree matches 1 run replaceitem entity @s hotbar.1 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 3 if score 2 tbcBreakfree matches 1 run replaceitem entity @s hotbar.2 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 4 if score 3 tbcBreakfree matches 1 run replaceitem entity @s hotbar.3 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 5 if score 4 tbcBreakfree matches 1 run replaceitem entity @s hotbar.4 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 6 if score 5 tbcBreakfree matches 1 run replaceitem entity @s hotbar.5 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 7 if score 6 tbcBreakfree matches 1 run replaceitem entity @s hotbar.6 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 8 if score 7 tbcBreakfree matches 1 run replaceitem entity @s hotbar.7 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 9 if score 8 tbcBreakfree matches 1 run replaceitem entity @s hotbar.8 minecraft:diamond_hoe{HideFlags:63,Damage:242,Unbreakable:1}
