...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 2 as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=45.01..135] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[180.0f,0.0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcBreakfree"]}
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 2 as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=-134.99..-45] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[0.0f,0.0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcBreakfree"]}
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 2 as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=-44.99..45] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[90.0f,0.0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcBreakfree"]}
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 2 as @e[tag=tbcSelPlayerAS] at @s if entity @s[y_rotation=135.01..-135] run summon minecraft:armor_stand ^-1.15 ^-1.25 ^ {Rotation:[-90.0f,0.0f],NoGravity:1,Invisible:1,Tags:["tbc","tbcBreakfree"]}
...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.0 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.1 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.2 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.3 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.4 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.5 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.6 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.7 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run item replace entity @s hotbar.8 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},custom_name='""',hide_additional_tooltip={}]
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 0 tbcBreakfree matches 1 run item replace entity @s hotbar.0 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 1 tbcBreakfree matches 1 run item replace entity @s hotbar.1 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 2 tbcBreakfree matches 1 run item replace entity @s hotbar.2 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 3 tbcBreakfree matches 1 run item replace entity @s hotbar.3 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 4 tbcBreakfree matches 1 run item replace entity @s hotbar.4 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 5 tbcBreakfree matches 1 run item replace entity @s hotbar.5 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 6 tbcBreakfree matches 1 run item replace entity @s hotbar.6 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 7 tbcBreakfree matches 1 run item replace entity @s hotbar.7 with minecraft:nether_star[custom_name='""']
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if score 8 tbcBreakfree matches 1 run item replace entity @s hotbar.8 with minecraft:nether_star[custom_name='""']
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 1 if score 0 tbcBreakfree matches 1 run item replace entity @s hotbar.0 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 2 if score 1 tbcBreakfree matches 1 run item replace entity @s hotbar.1 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 3 if score 2 tbcBreakfree matches 1 run item replace entity @s hotbar.2 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 4 if score 3 tbcBreakfree matches 1 run item replace entity @s hotbar.3 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 5 if score 4 tbcBreakfree matches 1 run item replace entity @s hotbar.4 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 6 if score 5 tbcBreakfree matches 1 run item replace entity @s hotbar.5 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 7 if score 6 tbcBreakfree matches 1 run item replace entity @s hotbar.6 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 8 if score 7 tbcBreakfree matches 1 run item replace entity @s hotbar.7 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score clicked tbcStats matches 9 if score 8 tbcBreakfree matches 1 run item replace entity @s hotbar.8 with minecraft:diamond_hoe[damage=242,unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score failed tbcBreakfree matches 1 run tellraw @a ["",[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@s","interpret":true}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.failure3"}]
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 1..60 if score count tbcBreakfree matches 0 run tellraw @a ["",[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@s","interpret":true}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.success3"}]
