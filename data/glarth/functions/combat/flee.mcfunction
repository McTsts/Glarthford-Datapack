...
execute as @r[tag=inTBC] at @s if entity @a[distance=0.1..,tag=inTBC] run tellraw @a ["\n",{"translate":"tbc","bold":true,"color":"aqua"},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.flee.mp","color":"aqua","with":[{"block":"84 26 -123","nbt":"Text1","interpret":true,"color":"aqua"}]}]
execute as @r[tag=inTBC] at @s unless entity @a[distance=0.1..,tag=inTBC] unless entity @e[tag=tbcAlly] run tellraw @a ["\n",{"translate":"tbc","bold":true,"color":"aqua"},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.flee.sp","color":"aqua","with":[{"block":"84 26 -123","nbt":"Text1","interpret":true,"color":"aqua"}]}]
