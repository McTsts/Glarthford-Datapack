...
execute as @e[tag=tbcEnemy2] run function glarth:combat/entity/piglin_brute
execute as @e[tag=tbcEnemy3] run function glarth:combat/entity/piglin_brute

function glarth:combat/start

scoreboard players set @a MusicSet 60