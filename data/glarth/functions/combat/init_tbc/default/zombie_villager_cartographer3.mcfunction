...
execute as @e[tag=tbcEnemy1] run function glarth:combat/entity/zombie_ghost
execute as @e[tag=tbcEnemy2] run function glarth:combat/entity/zombie_villager
execute as @e[tag=tbcEnemy3] run function glarth:combat/entity/zombie_villager_cartographer
