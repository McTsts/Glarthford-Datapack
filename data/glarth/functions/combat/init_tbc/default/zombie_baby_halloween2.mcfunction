...
execute as @e[tag=tbcEnemy2] run function glarth:combat/entity/spawner_zombie
execute as @e[tag=tbcEnemy3] run function glarth:combat/entity/zombie_chicken
