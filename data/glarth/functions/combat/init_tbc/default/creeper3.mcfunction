...
execute as @e[tag=tbcEnemy2] run function glarth:combat/entity/creeper
execute as @e[tag=tbcEnemy3] run function glarth:combat/entity/creeper
execute as @e[tag=tbcEnemy4] run function glarth:combat/entity/corrupted_ent

function glarth:combat/start

scoreboard players set @a MusicSet 31