...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 5 run scoreboard players set @e[tag=tbcEnemy] tbcSel 0
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 5 run scoreboard players set @e[tag=tbcEnemy,sort=nearest,limit=1,tag=!tbcUnselectable,tag=!tbcBlock] tbcSel 1
...
execute if score @s tbcAttackStage matches 1 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.4 ~ ~
execute if score @s tbcAttackStage matches 1 if entity @e[tag=tbcMarkerMiddle,distance=..0.4,type=area_effect_cloud] run function glarth:combat/action_companion/util/next_stage

execute if score @s tbcAttackStage matches 2 facing entity @e[scores={tbcSel=1}] feet rotated ~ 0 run tp @s ^ ^ ^0.4 ~ ~
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 5 run scoreboard players set damage tbcStats 160
...
execute if score @s tbcAttackStage matches 4 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.4 ~ ~
execute if score @s tbcAttackStage matches 4 if entity @e[tag=tbcMarkerMiddle,distance=..0.4,type=area_effect_cloud] run function glarth:combat/action_companion/util/next_stage

execute if score @s tbcAttackStage matches 5 facing entity @e[tag=tbcSelcMarker,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.4 ~ ~
execute if score @s tbcAttackStage matches 5 if entity @e[tag=tbcSelcMarker,distance=..0.4,type=area_effect_cloud] run function glarth:combat/action_companion/util/next_stage
