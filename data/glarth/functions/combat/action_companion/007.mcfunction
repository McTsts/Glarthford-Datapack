...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run tag @e[scores={tbcSel=1}] add tbcTempTarget
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if entity @e[tag=tbcTempTarget,tag=tbcBlock] run scoreboard players set @e[tag=tbcEnemy] tbcSel 0
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 if entity @e[tag=tbcTempTarget,tag=tbcBlock] run scoreboard players set @e[tag=tbcEnemy,sort=nearest,limit=1,tag=!tbcUnselectable] tbcSel 1
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 3 run data merge entity @s {Sitting:0b}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 5 run function glarth:combat/action_companion/util/next_stage
...
execute if score @s tbcAttackStage matches 2 facing entity @e[scores={tbcSel=1}] feet rotated ~ 0 run tp @s ^ ^ ^0.35 ~ ~
...
execute if score @s tbcAttackStage matches 4 if entity @e[tag=tbcMarkerMiddle,distance=..0.2,type=area_effect_cloud] run function glarth:combat/action_companion/util/next_stage

execute if score @s tbcAttackStage matches 5 facing entity @e[tag=tbcSelcMarker,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.35 ~ ~
execute if score @s tbcAttackStage matches 5 if entity @e[tag=tbcSelcMarker,distance=..0.2,type=area_effect_cloud] run function glarth:combat/action_companion/util/next_stage
...
execute if score @s tbcAttackStage matches 6 if score @s tbcAttackTimer matches 4 run data merge entity @s {Sitting:1b}
...
execute if score @s tbcAttackStage matches 6 if score @s tbcAttackTimer matches 6 run function glarth:combat/action_companion/util/done