execute if score TBC Stats matches 1 if entity @s[tag=!tbcBlock,tag=!tbcInvisibleDeath,tag=!tbcDestroyDeath] run tellraw @a ["",[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@e[tag=tbcTurn,type=player]","interpret":true},{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.death2","with":[[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@s[type=player]","interpret":true},{"nbt":"CustomName","entity":"@s[type=!player]","interpret":true}]]}]
execute if score TBC Stats matches 1 if entity @s[tag=!tbcBlock,tag=!tbcInvisibleDeath,tag=tbcDestroyDeath] run tellraw @a ["",[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@e[tag=tbcTurn,type=player]","interpret":true},{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.death3","with":[[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@s[type=player]","interpret":true},{"nbt":"CustomName","entity":"@s[type=!player]","interpret":true}]]}]
