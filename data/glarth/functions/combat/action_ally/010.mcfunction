...
execute if score @s tbcAttackStage matches 0 run replaceitem entity @s armor.head diamond_hoe{Damage:113}
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 5 run scoreboard players operation damage tbcStats *= 3 Const
...
execute if score @s tbcAttackStage matches 6 if score @s tbcAttackTimer matches 10 run replaceitem entity @s armor.head diamond_hoe{Damage:14}
