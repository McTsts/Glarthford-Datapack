...
execute as @e[tag=tbcArrowP,type=armor_stand] at @s if entity @e[scores={tbcSel=1},type=armor_stand,distance=..0.3] run tag @s add func
...
execute as @e[tag=tbcArrowP,tag=func,type=armor_stand] at @s run scoreboard players operation damage tbcStats /= 3 Const
execute as @e[tag=tbcArrowP,tag=func,type=armor_stand] at @s run scoreboard players operation damage tbcStats > 10 Const
execute as @e[tag=tbcArrowP,tag=func,type=armor_stand] at @s run scoreboard players set fire tbcStats 2
