...
execute if score dodged tbcStats matches 2 run tellraw @a ["",{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[tag=tbcTurn,limit=1]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.miss","with":[[{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[scores={tbcSel=1}]","interpret":true}]]}]
execute if score dodged tbcStats matches 1 run tellraw @a ["",{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[tag=tbcTurn,limit=1]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.dodged","with":[{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[scores={tbcSel=1}]","interpret":true}]}]
execute if score dodged tbcStats matches 0 if score damage tbcStats matches 1.. run tellraw @a ["",{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[tag=tbcTurn,limit=1]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.success","with":[{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[scores={tbcSel=1}]","interpret":true},{"nbt":"out","storage":"ntca:io","interpret":true,"color":"red"}]}]
execute if score dodged tbcStats matches 0 unless score damage tbcStats matches 1.. run tellraw @a ["",{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[tag=tbcTurn,limit=1]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.failure","with":[{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[scores={tbcSel=1}]","interpret":true}]}]
