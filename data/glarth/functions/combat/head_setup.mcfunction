...
data merge block 84 26 -123 {front_text:{messages:['{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@a[scores={playerid=1},gamemode=adventure]","interpret":true}']}}
data modify entity @e[type=armor_stand,limit=1,tag=tbcPlayerAS1] CustomName set from block 84 26 -123 front_text.messages[0]
data merge block 84 26 -123 {front_text:{messages:['{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@a[scores={playerid=2},gamemode=adventure]","interpret":true}']}}
data modify entity @e[type=armor_stand,limit=1,tag=tbcPlayerAS2] CustomName set from block 84 26 -123 front_text.messages[0]
data merge block 84 26 -123 {front_text:{messages:['{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@a[scores={playerid=3},gamemode=adventure]","interpret":true}']}}
