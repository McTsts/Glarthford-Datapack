...
execute if score combat Stats matches 0 if score difficulty Stats matches 1..3 unless score lobbyTBC Stats matches 2 run tag @e[tag=tbcLoot,type=area_effect_cloud] add loot_enderPriest
execute if score combat Stats matches 0 if score difficulty Stats matches 1..3 run schedule function glarth:combat/init_tbc/boss/ender_priest2 20
# Other
