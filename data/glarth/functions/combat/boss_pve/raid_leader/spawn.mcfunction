execute as @e[tag=raid_leader] at @s run summon minecraft:pillager ~ ~ ~ {Health:70.0f,HandItems:[{id:"minecraft:crossbow",count:1},{}],Attributes:[{Name:"generic.maxHealth",Base:70},{Name:"generic.movementSpeed",Base:0.25d},{Name:"generic.attackDamage",Base:2},{Name:"generic.attackKnockback",Base:5},{Name:"zombie.spawnReinforcements",Base:100}],CustomName:'{"translate":"raid_leader","color":"dark_red"}',CustomNameVisible:1,Tags:["raid_leader_boss","boss"]}
