...
execute if entity @s[type=!player,scores={tbcHealth=2..},tag=tbcAlly] run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@s[type=!player]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.poisoned","with":[{"text":"1.±","color":"red"}]}]
execute if entity @s[type=!player,scores={tbcHealth=..1},tag=tbcAlly] run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@s[type=!player]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.poisoned","with":[{"text":"±.±","color":"red"}]}]
