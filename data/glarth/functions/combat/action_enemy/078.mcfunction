...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 20 unless entity @s[tag=tbcEnderPriest] run function glarth:dialogue/necromancer/lines/attack3
