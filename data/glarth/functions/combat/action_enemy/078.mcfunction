...
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 2 as @e[tag=tbcEnemy2,type=armor_stand] run function glarth:combat/entity/n_groundskeeper
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 3 as @e[tag=tbcEnemy3,type=armor_stand] run function glarth:combat/entity/n_groundskeeper
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 4 as @e[tag=tbcEnemy4,type=armor_stand] run function glarth:combat/entity/n_groundskeeper
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 5 as @e[tag=tbcEnemy5,type=armor_stand] run function glarth:combat/entity/n_groundskeeper
...
execute if score @s tbcAttackStage matches 1 unless entity @s[tag=tbcEnderPriest] run schedule function glarth:dialogue/necromancer/lines/attack3 30t
execute if score @s tbcAttackStage matches 1 unless entity @s[tag=tbcEnderPriest] run function glarth:dialogue/groundskeeper/lines/attack1
