...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 10 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with diamond_hoe{CustomModelData:264}
...
execute if score @s tbcAttackStage matches 5 if score @s tbcAttackTimer matches 10 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with diamond_hoe{CustomModelData:264}
...
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 10 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with diamond_hoe{CustomModelData:264}
...
execute if score @s tbcAttackStage matches 8 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with diamond_hoe{CustomModelData:361}
...
execute if score @s tbcAttackStage matches 9 if score @s tbcAttackTimer matches 10 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with diamond_hoe{CustomModelData:264}
...
execute if score @s tbcAttackStage matches 10 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with diamond_hoe{CustomModelData:361}
...
execute if score @s tbcAttackStage matches 11 if score @s tbcAttackTimer matches 10 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with diamond_hoe{CustomModelData:264}
