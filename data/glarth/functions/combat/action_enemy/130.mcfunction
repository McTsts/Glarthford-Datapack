...
execute if score @s tbcAttackStage matches 0 if entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud,distance=..0.3] run data merge entity @s {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.zombie.ghost","color":"white"}'}}},{},{},{}],CustomNameVisible:0,CustomName:'{"translate":"tbc.enemy.zombie.ghost","color":"white"}',Team:"aqua"}
