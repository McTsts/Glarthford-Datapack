...
execute if score @s tbcAttackStage matches 0 if entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud,distance=..0.3] run data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.zombie.ghost","color":"white"}'}},{},{},{}],CustomNameVisible:0,CustomName:"{\"translate\":\"tbc.enemy.zombie.ghost\",\"color\":\"white\"}",Team:"aqua"}
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 3 run data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.zombie.ghost","color":"white"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:164}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.zombie.ghost\",\"color\":\"white\"}",Team:"aqua"}
