...
execute if score @s tbcAttackStage matches 2 run tag @s add tbcUnselectable
execute if score @s tbcAttackStage matches 2 run tag @e[tag=tbcEnemy,tag=!tbcUnselectable] add rand_sel
execute if score @s tbcAttackStage matches 2 run function glarth:util/rand_sel/1
execute if score @s tbcAttackStage matches 2 run scoreboard players set @e[tag=rand_sel_result] tbcSel 1
execute if score @s tbcAttackStage matches 2 run scoreboard players set @s tbcSel 0
execute if score @s tbcAttackStage matches 2 run function glarth:combat/selection
execute if score @s tbcAttackStage matches 2 run function glarth:mechanic/dim_end/forcefield_tbc
execute if score @s tbcAttackStage matches 2 run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 3 run scoreboard players add @s tbcAttackTimer 1
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 50 run function glarth:combat/action_enemy/util/done