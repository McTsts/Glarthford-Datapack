...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 5 run function glarth:combat/action_enemy/util/get_target
...
execute if score @s tbcAttackStage matches 2 run function glarth:combat/action_enemy/helper/summon_arrow_parallel
execute if score @s tbcAttackStage matches 2 run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest] feet
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 12 run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 4 run function glarth:combat/action_enemy/helper/summon_arrow_parallel
execute if score @s tbcAttackStage matches 4 run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest] feet
...
execute if score @s tbcAttackStage matches 6 run function glarth:combat/action_enemy/helper/summon_arrow_parallel
execute if score @s tbcAttackStage matches 6 run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest] feet
...
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 12 run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 8 run function glarth:combat/action_enemy/helper/summon_arrow_parallel
execute if score @s tbcAttackStage matches 8 run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest] feet
...
execute if score @s tbcAttackStage matches 9 if score @s tbcAttackTimer matches 12 run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 10 run scoreboard players add @s tbcAttackTimer 1
execute if score @s tbcAttackStage matches 10 if score @s tbcAttackTimer matches 20.. unless entity @e[tag=tbcArrowP] run function glarth:combat/action_enemy/util/next_stage
execute if score @s tbcAttackStage matches 2..10 run function glarth:combat/action_enemy/helper/arrow_parallel

execute if score @s tbcAttackStage matches 11 facing entity @e[tag=tbcSelMarker] feet rotated ~ 0 run tp @s ^ ^ ^0.3 ~ ~
