...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 11..20 run particle minecraft:witch ~ ~0.25 ~ 1 1 1 0.1 1
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 21..30 run particle minecraft:witch ~ ~0.25 ~ 1 1 1 0.1 4
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 31..40 run particle minecraft:witch ~ ~0.25 ~ 1 1 1 0.1 16
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 41..50 run particle minecraft:witch ~ ~0.25 ~ 1 1 1 0.1 64
...
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 1 as @e[tag=tbcEnemy1,type=armor_stand] run function glarth:combat/entity/zombie_sewage
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 2 as @e[tag=tbcEnemy2,type=armor_stand] run function glarth:combat/entity/zombie_sewage
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 3 as @e[tag=tbcEnemy3,type=armor_stand] run function glarth:combat/entity/zombie_sewage
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 4 as @e[tag=tbcEnemy4,type=armor_stand] run function glarth:combat/entity/zombie_baby
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 5 as @e[tag=tbcEnemy5,type=armor_stand] run function glarth:combat/entity/zombie_knight
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 1 run tag @e[tag=tbcEnemy1,type=armor_stand] add stage_020
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 2 run tag @e[tag=tbcEnemy2,type=armor_stand] add stage_020
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 3 run tag @e[tag=tbcEnemy3,type=armor_stand] add stage_020
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 4 run tag @e[tag=tbcEnemy4,type=armor_stand] add stage_020
execute if score @s tbcAttackStage matches 1 if score noEnemy Temp matches 5 run tag @e[tag=tbcEnemy5,type=armor_stand] add stage_020
