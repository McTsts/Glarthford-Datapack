...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 8 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:ash ^ ^1 ^1 0.7 0.7 0.7 0.1 200
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 8 run scoreboard players operation infection tbcStats = @s tbcStrength
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 8 run scoreboard players operation infection tbcStats /= 20 Const
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 8 run scoreboard players add infection tbcStats 1
...
execute if score @s tbcAttackStage matches 3 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.3 ~ ~
...
execute if score @s tbcAttackStage matches 4 facing entity @e[tag=tbcSelMarker] feet rotated ~ 0 run tp @s ^ ^ ^0.3 ~ ~
