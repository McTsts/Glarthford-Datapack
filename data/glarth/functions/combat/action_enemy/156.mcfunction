...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 1..9 run tp @s ^ ^ ^-0.083
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 10 run particle minecraft:portal ~ ~ ~ 0.4 0.4 0.4 1 500
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 45 as @e[tag=tbcTargetAS] run function glarth:combat/set_loc
