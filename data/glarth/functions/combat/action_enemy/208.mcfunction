...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 20 at @e[tag=tbcStrWither,limit=1] run particle block{block_state:{Name:"soul_sand"}} ~ ~1 ~ 0.5 0.5 0.5 0.5 100
