...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 10 run replaceitem entity @e[tag=tbcGhastDisModel,limit=1] armor.head diamond_hoe{CustomModelData:361}
