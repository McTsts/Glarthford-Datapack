...
function glarth:combat/action_enemy/attacks/barrage_partial {speed:0.2,min:2,max:4,positions:"moon",item:"minecraft:blaze_rod",helper:"bone_fire",color:"dark_gray"}

# select & barrage 2-4 blaze rods
