...
tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@e[tag=tbcTurn]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.failure2.c","with":[{"nbt":"out","storage":"ntca:io","interpret":true,"color":"red"}]}]