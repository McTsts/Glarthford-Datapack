...
execute if score armorReduction tbcStats matches 0 run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true},{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@e[tag=tbcTurn,type=player]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.armor","with":[[{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}],{"text":"±","color":"red"}]}]
execute if score armorReduction tbcStats matches 1 run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true},{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@e[tag=tbcTurn,type=player]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.armor","with":[[{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}],{"text":"1","color":"red"}]}]
execute if score armorReduction tbcStats matches 2 run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true},{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@e[tag=tbcTurn,type=player]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.armor","with":[[{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}],{"text":"2","color":"red"}]}]
execute if score armorReduction tbcStats matches 3 run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true},{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@e[tag=tbcTurn,type=player]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.armor","with":[[{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}],{"text":"3","color":"red"}]}]
execute if score armorReduction tbcStats matches 4 run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true},{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@e[tag=tbcTurn,type=player]","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.armor","with":[[{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}],{"text":"4","color":"red"}]}]