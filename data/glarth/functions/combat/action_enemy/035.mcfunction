execute if score @s tbcAttackStage matches 0 run tag @e[tag=tbcMarkerMiddleB,limit=1,sort=furthest] add tbcMarkerMiddleX
execute if score @s tbcAttackStage matches 0 run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 1 facing entity @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.2 ~ ~
...
execute if score @s tbcAttackStage matches 4 facing entity @e[tag=tbcMarkerMiddleB,tag=!tbcMarkerMiddleX,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.2 ~ ~
execute if score @s tbcAttackStage matches 4 if entity @e[tag=tbcMarkerMiddleB,tag=!tbcMarkerMiddleX,type=area_effect_cloud,distance=..0.2] run function glarth:combat/action_enemy/util/next_stage
