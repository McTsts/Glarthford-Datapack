execute as @e[tag=lava_dragon6,type=armor_stand] at @s run function glarth:mechanic/animation/lava_dragon/main

# Dragon Start
execute if score @s tbcAttackStage matches 0 positioned ~ ~-10 ~ run function glarth:mechanic/animation/lava_dragon/s6
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 16 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block{block_state:{Name:"stone"}} ^ ^1 ^1 0 0 0 0 100
...
execute if score @s tbcAttackStage matches 9 if score @s tbcAttackTimer matches 16 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block{block_state:{Name:"stone"}} ^ ^1 ^1 0 0 0 0 100
...
# End
execute if score @s tbcAttackStage matches 13 run kill @e[tag=lava_dragonP]
execute if score @s tbcAttackStage matches 13 run function glarth:combat/action_enemy/util/done

# Dragon
execute as @e[tag=ldX3,type=armor_stand] at @s positioned ~ ~0.2 ~ if entity @e[tag=tbcTargetAS,type=armor_stand,distance=..0.6] run particle minecraft:portal ~ ~ ~ 0.3 0.3 0.3 0 10
execute as @e[tag=ldX3,type=armor_stand] at @s positioned ~ ~0.2 ~ if entity @e[tag=tbcTargetAS,type=armor_stand,distance=..0.6] run particle minecraft:portal ~ ~ ~ 0.3 0.3 0.3 0.1 10
execute as @e[tag=ldX3,type=armor_stand] at @s positioned ~ ~0.2 ~ if entity @e[tag=tbcTargetAS,type=armor_stand,distance=..0.6] run particle minecraft:dragon_breath ~ ~ ~ 0.3 0.3 0.3 0.1 1
...
execute as @e[tag=ldX3,type=armor_stand] at @s positioned ~ ~0.2 ~ if entity @e[tag=tbcTargetAS,type=armor_stand,distance=..0.2] unless score @s lavaDragonAtStg matches 2.. run scoreboard players set damage tbcStats 20
