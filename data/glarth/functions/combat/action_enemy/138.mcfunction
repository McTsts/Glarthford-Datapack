...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 25 run item replace entity @a[tag=tbcTarget] armor.head with carved_pumpkin{display:{Name:'""'},Enchantments:[{id:"binding_curse",lvl:1}],CustomModelData:1,HideFlags:63}
