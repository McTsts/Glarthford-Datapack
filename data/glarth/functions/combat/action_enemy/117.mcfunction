...
execute if score @s tbcAttackStage matches 0..1 if score @s tbcAttackTimerX matches 35 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with minecraft:diamond_hoe[custom_model_data=361]
...
execute if score @s tbcAttackStage matches 0..1 if score @s tbcAttackTimerX matches 55 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with minecraft:diamond_hoe[custom_model_data=264]
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 20 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with minecraft:diamond_hoe[custom_model_data=264]
...
execute if score @s tbcAttackStage matches 5 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with minecraft:diamond_hoe[custom_model_data=361]
...
execute if score @s tbcAttackStage matches 6 if score @s tbcAttackTimer matches 20 run item replace entity @e[tag=tbcGhastDisModel,limit=1] armor.head with minecraft:diamond_hoe[custom_model_data=264]
