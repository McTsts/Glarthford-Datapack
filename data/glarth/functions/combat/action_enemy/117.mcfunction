...
execute if score @s tbcAttackStage matches 0..1 if score @s tbcAttackTimerX matches 35 run replaceitem entity @e[tag=tbcGhastDisModel,limit=1] armor.head diamond_hoe{CustomModelData:361}
...
execute if score @s tbcAttackStage matches 0..1 if score @s tbcAttackTimerX matches 55 run replaceitem entity @e[tag=tbcGhastDisModel,limit=1] armor.head diamond_hoe{CustomModelData:264}
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 20 run replaceitem entity @e[tag=tbcGhastDisModel,limit=1] armor.head diamond_hoe{CustomModelData:264}
...
execute if score @s tbcAttackStage matches 5 run replaceitem entity @e[tag=tbcGhastDisModel,limit=1] armor.head diamond_hoe{CustomModelData:361}
...
execute if score @s tbcAttackStage matches 6 if score @s tbcAttackTimer matches 20 run replaceitem entity @e[tag=tbcGhastDisModel,limit=1] armor.head diamond_hoe{CustomModelData:264}
