execute if score @s tbcAttackStage matches 0 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.4 ~ ~
execute if score @s tbcAttackStage matches 0 if entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud,distance=..0.3] run data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.zombie.ghost","color":"white"}'}},{},{},{}],CustomNameVisible:0,CustomName:"{\"translate\":\"tbc.enemy.zombie.ghost_mayor\",\"color\":\"white\"}",Team:"aqua"}
...
execute if score @s tbcAttackStage matches 1 facing entity @e[tag=tbcTargetAS,type=armor_stand] feet rotated ~ 0 run tp @s ^ ^ ^0.3 ~ ~
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 3 run data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.zombie.ghost_mayor","color":"white"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:521}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.zombie.ghost_mayor\",\"color\":\"white\"}",Team:"aqua"}
...
execute if score @s tbcAttackStage matches 3 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.45 ~ ~
...
execute if score @s tbcAttackStage matches 4 facing entity @e[tag=tbcSelMarker] feet rotated ~ 0 run tp @s ^ ^ ^0.45 ~ ~
execute if score @s tbcAttackStage matches 4 if entity @e[tag=tbcSelMarker,distance=..0.3] run function glarth:combat/action_enemy/util/done