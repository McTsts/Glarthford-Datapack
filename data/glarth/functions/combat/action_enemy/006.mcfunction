...
execute if score @s tbcAttackStage matches 5 as @e[scores={tbcID=2}] at @s facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.35 ~ ~
...
#6
execute if score @s tbcAttackStage matches 6 as @e[scores={tbcID=2}] at @s facing entity @e[scores={tbcIDM=2}] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.35 ~ ~
