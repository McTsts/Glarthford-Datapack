...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 11 as @e[tag=tbcAttackDummy] at @s if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block{block_state:{Name:"stone"}} ^ ^1 ^1 0 0 0 0 100
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 40 as @e[tag=tbcTarget,limit=1] run function glarth:combat/action/blocking_init
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 40 run kill @e[tag=tbcAttackDummy]
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 40 run function glarth:combat/action_enemy/util/done
