...
execute if score @s tbcAttackStage matches 1 run scoreboard players add n Random 1
execute if score @s tbcAttackStage matches 1 at @s run playsound minecraft:entity.illusioner.cast_spell hostile @a ~ ~ ~ 1 1.5
execute if score @s tbcAttackStage matches 1 if score n Random matches 1..8 run summon minecraft:armor_stand ^ ^-2.00 ^2.7 {ArmorItems:[{},{},{},{id:"bookshelf",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 2..8 run summon minecraft:armor_stand ^ ^-1.38 ^2.7 {ArmorItems:[{},{},{},{id:"bookshelf",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 3..8 run summon minecraft:armor_stand ^ ^-0.76 ^2.7 {ArmorItems:[{},{},{},{id:"bookshelf",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 4..8 run summon minecraft:armor_stand ^ ^-0.14 ^2.7 {ArmorItems:[{},{},{},{id:"bookshelf",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 5..8 run summon minecraft:armor_stand ^ ^0.480 ^2.7 {ArmorItems:[{},{},{},{id:"bookshelf",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 6..8 run summon minecraft:armor_stand ^ ^1.100 ^2.7 {ArmorItems:[{},{},{},{id:"bookshelf",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
...
execute if score @s tbcAttackStage matches 1 if score n Random matches 2 run scoreboard players set @s tbcAttackStage 11
execute if score @s tbcAttackStage matches 1 if score n Random matches 3 run scoreboard players set @s tbcAttackStage 9
execute if score @s tbcAttackStage matches 1 if score n Random matches 4 run scoreboard players set @s tbcAttackStage 7
execute if score @s tbcAttackStage matches 1 if score n Random matches 5 run scoreboard players set @s tbcAttackStage 5
execute if score @s tbcAttackStage matches 1 if score n Random matches 6 run scoreboard players set @s tbcAttackStage 3
...
execute if score @s tbcAttackStage matches 3..14 run function glarth:combat/action_enemy/helper/block
