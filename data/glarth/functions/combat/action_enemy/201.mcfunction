...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 01 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.9
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 03 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.9
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 05 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.9
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 07 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.9
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 19 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.6
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 21 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.6
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 23 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.6
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 37 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.3
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 39 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.3
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 55 run playsound minecraft:block.snow.break hostile @a ~ ~ ~ 1 1.0
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 01..30 at @s run particle minecraft:block{block_state:{Name:"snow_block"}} ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 10..40 at @s run particle minecraft:block{block_state:{Name:"snow_block"}} ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 20..50 at @e[tag=tbcTargetAS,type=armor_stand] run particle minecraft:block{block_state:{Name:"snow_block"}} ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 30..60 at @e[tag=tbcTargetAS,type=armor_stand] run particle minecraft:block{block_state:{Name:"snow_block"}} ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 40..60 at @e[tag=tbcTargetAS,type=armor_stand] run particle minecraft:block{block_state:{Name:"snow_block"}} ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 70 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run scoreboard players set @e[tag=tbcTarget,limit=1] tbcCantMoveType 3
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 70 if score @e[tag=tbcTarget,limit=1] blocked matches 0 as @e[tag=tbcTargetAS,type=armor_stand] at @s run item replace entity @e[tag=charQ5,sort=nearest,limit=1] armor.head with minecraft:diamond_hoe[custom_model_data=474]
