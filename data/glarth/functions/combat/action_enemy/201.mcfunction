...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 01..30 at @s run particle minecraft:block snow_block ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 10..40 at @s run particle minecraft:block snow_block ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 20..50 at @e[tag=tbcTargetAS,type=armor_stand] run particle minecraft:block snow_block ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 30..60 at @e[tag=tbcTargetAS,type=armor_stand] run particle minecraft:block snow_block ~ ~ ~ 0.6 0.6 0.6 0.1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 40..60 at @e[tag=tbcTargetAS,type=armor_stand] run particle minecraft:block snow_block ~ ~ ~ 0.6 0.6 0.6 0.1 2
