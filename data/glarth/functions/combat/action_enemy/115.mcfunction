...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 8 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:witch ^ ^1 ^1 0 0 0 0 100
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 8 run scoreboard players operation poison tbcStats = @s tbcStrength
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 8 run scoreboard players operation poison tbcStats /= 20 Const
