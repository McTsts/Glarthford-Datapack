...
execute if score @s tbcAttackStage matches 2..4 run function glarth:combat/action_enemy/helper/fangs

execute if score @s tbcAttackStage matches 4 run function glarth:combat/action_enemy/stages/generic/wait {delay:20}
