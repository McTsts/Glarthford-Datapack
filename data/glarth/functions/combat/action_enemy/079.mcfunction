...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 10 run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@s","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.aoe_heal_enemy","with":[{"score":{"name":"heal","objective":"tbcStats"},"color":"green"},".",{"score":{"name":"healX","objective":"tbcStats"}}]}]
execute if score @s tbcAttackStage matches 0 if score @s[tag=stage_012] tbcAttackTimer matches 10 run tellraw @a ["",{"nbt":"ArmorItems[0].tag.CustomName","entity":"@s","interpret":true},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.empowered","with":[{"text":"1","color":"blue"}]}]
