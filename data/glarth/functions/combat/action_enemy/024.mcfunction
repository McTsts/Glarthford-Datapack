...
execute if score @s tbcAttackStage matches 10 run function glarth:combat/action_enemy/helper/summon_arrow
...
execute if score @s tbcAttackStage matches 2..12 run function glarth:combat/action_enemy/helper/arrow
