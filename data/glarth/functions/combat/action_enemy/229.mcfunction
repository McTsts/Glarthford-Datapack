execute if score @s tbcAttackStage matches 0 run item replace entity @s armor.head with diamond_hoe{CustomModelData:528}
...
execute if score @s tbcAttackStage matches 5 if entity @e[tag=tbcSelMarker,distance=..0.3] run item replace entity @s armor.head with diamond_hoe{CustomModelData:527}
