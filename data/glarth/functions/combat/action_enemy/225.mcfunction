...
execute if score @s tbcAttackStage matches 1 if score evilAttackData Temp matches 1 run summon minecraft:armor_stand ^ ^-2.00 ^0.7 {ArmorItems:[{},{},{},{id:"egg",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"white"}
execute if score @s tbcAttackStage matches 1 if score evilAttackData Temp matches 2 run summon minecraft:armor_stand ^ ^-2.00 ^0.7 {ArmorItems:[{},{},{},{id:"snowball",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"white"}
execute if score @s tbcAttackStage matches 1 if score evilAttackData Temp matches 3 run summon minecraft:armor_stand ^ ^-2.00 ^0.7 {ArmorItems:[{},{},{},{id:"ink_sac",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gray"}
execute if score @s tbcAttackStage matches 1 if score evilAttackData Temp matches 4 run summon minecraft:armor_stand ^ ^-2.00 ^0.7 {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":526}}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 1 if score evilAttackData Temp matches 5 run summon minecraft:armor_stand ^ ^-2.00 ^0.7 {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":38}}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gray"}
execute if score @s tbcAttackStage matches 1 if score evilAttackData Temp matches 6 run summon minecraft:armor_stand ^ ^-2.00 ^0.7 {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":203}}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score evilAttackData Temp matches 7 run summon minecraft:armor_stand ^ ^-2.00 ^0.7 {ArmorItems:[{},{},{},{id:"gold_nugget",count:1,components:{"minecraft:custom_model_data":1}}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"dark_purple"}
