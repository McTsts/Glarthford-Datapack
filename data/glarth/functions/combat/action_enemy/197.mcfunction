...
execute if score @s tbcAttackStage matches 4 run tag @s add tbcUnselectable
execute if score @s tbcAttackStage matches 4 run tag @e[tag=tbcEnemy,tag=!tbcUnselectable] add rand_sel
execute if score @s tbcAttackStage matches 4 run function glarth:util/rand_sel/1
execute if score @s tbcAttackStage matches 4 run scoreboard players set @e[tag=rand_sel_result] tbcSel 1
execute if score @s tbcAttackStage matches 4 run scoreboard players set @s tbcSel 0
execute if score @s tbcAttackStage matches 4 run function glarth:combat/selection
execute if score @s tbcAttackStage matches 4 run function glarth:mechanic/dim_end/forcefield_tbc
...
execute if score @s tbcAttackStage matches 5 if score @s tbcAttackTimer matches 50 run function glarth:combat/action_enemy/util/done