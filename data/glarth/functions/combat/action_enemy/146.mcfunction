...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 1 run summon minecraft:armor_stand ^-0.65 ^0.2 ^ {ArmorItems:[{},{},{},{id:"snowball",Count:1}],Small:1,Pose:{Head:[90f,-45f,-90f]},Marker:1,NoGravity:1,Invisible:1,Tags:["tbc","tbcArrowP","tbcArrow1"],Rotation:[-180f,0f]}
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 16 run summon minecraft:armor_stand ^-0.65 ^0.2 ^ {ArmorItems:[{},{},{},{id:"snowball",Count:1}],Small:1,Pose:{Head:[90f,-45f,-90f]},Marker:1,NoGravity:1,Invisible:1,Tags:["tbc","tbcArrowP","tbcArrow2"],Rotation:[-180f,0f]}
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 31 run summon minecraft:armor_stand ^-0.65 ^0.2 ^ {ArmorItems:[{},{},{},{id:"snowball",Count:1}],Small:1,Pose:{Head:[90f,-45f,-90f]},Marker:1,NoGravity:1,Invisible:1,Tags:["tbc","tbcArrowP","tbcArrow3"],Rotation:[-180f,0f]}
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 61 as @e[tag=tbcArrowP] run data merge entity @s {Pose:{Head:[90f,135f,-90f]}}
