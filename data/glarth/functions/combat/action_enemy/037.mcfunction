...
execute if score creeperTimer Temp matches 1..4 run data merge entity @s[tag=tbcCreeper] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.creeper.default","color":"green"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{Damage:147}}]}
execute if score creeperTimer Temp matches 1..4 run data merge entity @s[tag=tbcChargedCreeper] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.creeper.charged","color":"aqua"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:47}}]}
execute if score creeperTimer Temp matches 5..8 run data merge entity @s[tag=tbcCreeper] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.creeper.default","color":"green"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:46}}]}
execute if score creeperTimer Temp matches 5..8 run data merge entity @s[tag=tbcChargedCreeper] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.creeper.charged","color":"aqua"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:46}}]}
