...
execute if score @s tbcAttackStage matches 4 if score n Random matches 1..8 run summon minecraft:armor_stand ^ ^-2.00 ^2.7 {Pose:{Head:[0f,90f,0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"dark_purple"}
execute if score @s tbcAttackStage matches 4 if score n Random matches 3..8 run summon minecraft:armor_stand ^ ^-1.38 ^2.7 {Pose:{Head:[0f,90f,0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"dark_purple"}
execute if score @s tbcAttackStage matches 4 if score n Random matches 6..8 run summon minecraft:armor_stand ^ ^-0.76 ^2.7 {Pose:{Head:[0f,90f,0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"dark_purple"}
execute if score @s tbcAttackStage matches 4 if score n Random matches 8..8 run summon minecraft:armor_stand ^ ^-0.14 ^2.7 {Pose:{Head:[0f,90f,0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"dark_purple"}
