...
execute if score @s tbcAttackStage matches 1 unless entity @e[tag=tbcEnderPriest] run scoreboard players set r Random 5
execute if score @s tbcAttackStage matches 1 if entity @e[tag=tbcEnderPriest] run scoreboard players set r Random 3
