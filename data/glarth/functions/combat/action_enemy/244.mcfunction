...
execute if score @s tbcAttackStage matches 10 run function glarth:combat/action_enemy/helper/summon_arrow_parallel
...
execute if score @s tbcAttackStage matches 11 if score @s tbcAttackTimer matches 12 run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 12 run function glarth:combat/action_enemy/helper/summon_arrow_parallel
execute if score @s tbcAttackStage matches 12 run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest]
...
execute if score @s tbcAttackStage matches 13 if score @s tbcAttackTimer matches 12 run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 14 run scoreboard players add @s tbcAttackTimer 1
execute if score @s tbcAttackStage matches 14 if score @s tbcAttackTimer matches 20.. unless entity @e[tag=tbcArrowP] run function glarth:combat/action_enemy/util/next_stage
execute if score @s tbcAttackStage matches 2..14 run function glarth:combat/action_enemy/helper/arrow_parallel

execute if score @s tbcAttackStage matches 15 facing entity @e[tag=tbcSelMarker] feet rotated ~ 0 run tp @s ^ ^ ^0.3 ~ ~
