...
execute if score @s tbcAttackStage matches 1 if entity @e[tag=tbcTempMarker,distance=..2.5,type=area_effect_cloud] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=240]
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 17 run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=239]
