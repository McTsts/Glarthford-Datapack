...
execute if score @s tbcAttackStage matches 1 if entity @e[tag=tbcTempMarker,distance=..2.5,type=area_effect_cloud] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:240}
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 17 run replaceitem entity @s armor.head diamond_hoe{CustomModelData:239}
