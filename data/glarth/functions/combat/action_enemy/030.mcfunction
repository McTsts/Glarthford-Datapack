...
execute if score @s tbcAttackStage matches 2 if score n Random matches 1 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~ ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"nautilus_shell",Count:1}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1,Invulnerable:1,Fire:10000s}
execute if score @s tbcAttackStage matches 2 if score n Random matches 1..3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~90 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"nautilus_shell",Count:1}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1,Invulnerable:1,Fire:10000s}
execute if score @s tbcAttackStage matches 2 if score n Random matches 1..3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~-90 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"nautilus_shell",Count:1}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1,Invulnerable:1,Fire:10000s}
execute if score @s tbcAttackStage matches 2 if score n Random matches 3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~ ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"nautilus_shell",Count:1}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1,Invulnerable:1,Fire:10000s}
execute if score @s tbcAttackStage matches 2 if score n Random matches 3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~180 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"nautilus_shell",Count:1}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1,Invulnerable:1,Fire:10000s}
