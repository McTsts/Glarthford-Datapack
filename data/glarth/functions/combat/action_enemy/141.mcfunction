execute if score @s tbcAttackStage matches 0 at @e[tag=tbcTargetAS] facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 positioned ^ ^ ^1.5 run summon silverfish ~ ~ ~ {NoAI:1,Tags:["tbcSil140"]}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 21 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block{block_state:{Name:"stone"}} ^ ^1 ^1 0 0 0 0 100
...
execute if score @s tbcAttackStage matches 2 at @e[tag=tbcTargetAS] facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 positioned ^ ^ ^-1.5 run summon silverfish ~ ~ ~ {NoAI:1,Tags:["tbcSil140"]}
