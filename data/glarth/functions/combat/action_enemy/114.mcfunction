...
execute if score @s tbcAttackStage matches 0 at @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":352}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.spider.cave","color":"dark_gray"}',Tags:["tbcAttackDummy"]}
execute if score @s tbcAttackStage matches 0 at @e[tag=tbcMarkerMiddleY] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":352}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.spider.cave","color":"dark_gray"}',Tags:["tbcAttackDummy"]}
...
execute if score @s tbcAttackStage matches 0 as @e[tag=tbcTargetAS,type=armor_stand] at @s positioned ^ ^ ^ run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0.0f,Duration:2147483647,Tags:["tbcTempMarker","tbc"]}
...
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 10 run playsound minecraft:entity.spider.hurt hostile @a ~ ~ ~ 1 2
execute if score @s tbcAttackStage matches 1 if score @s tbcAttackTimer matches 20 run playsound minecraft:entity.spider.ambient hostile @a ~ ~ ~ 1 2
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 25 as @e[tag=tbcAD_Sel] at @s run playsound minecraft:entity.spider.death hostile @a ~ ~ ~ 1 1.7
...
execute if score @s tbcAttackStage matches 5 if score @s tbcAttackTimer matches 25 as @e[tag=tbcAD_Sel] at @s run playsound minecraft:entity.spider.death hostile @a ~ ~ ~ 1 1.7
...
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 0..13 rotated ~ 0 run tp @s ^ ^ ^0.07
...
execute if score @s tbcAttackStage matches 9 if entity @e[tag=tbcSelMarker,distance=..0.2,type=area_effect_cloud] run function glarth:combat/action_enemy/util/done