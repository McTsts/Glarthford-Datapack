...
execute if score @s tbcAttackStage matches 0 at @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:352}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.spider.cave\",\"color\":\"dark_gray\"}",Tags:["tbcAttackDummy"]}
execute if score @s tbcAttackStage matches 0 at @e[tag=tbcMarkerMiddleY] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:352}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.spider.cave\",\"color\":\"dark_gray\"}",Tags:["tbcAttackDummy"]}
