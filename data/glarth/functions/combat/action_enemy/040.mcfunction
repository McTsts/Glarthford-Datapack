...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 1 as @e[scores={tbcID=2}] run data merge entity @s {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":46}}]}
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 5 as @e[scores={tbcID=2}] run data merge entity @s[tag=tbcChargedCreeper] {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.creeper.charged","color":"aqua"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":47}}]}
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 5 as @e[scores={tbcID=2}] run data merge entity @s[tag=tbcCreeper] {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.creeper.default","color":"green"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":147}}]}
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 7 as @e[scores={tbcID=2}] run data merge entity @s[tag=tbcChargedCreeper] {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.creeper.charged","color":"aqua"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":46}}]}
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 7 as @e[scores={tbcID=2}] run data merge entity @s[tag=tbcCreeper] {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.creeper.default","color":"green"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":46}}]}
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 9 as @e[scores={tbcID=2}] run data merge entity @s[tag=tbcChargedCreeper] {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.creeper.charged","color":"aqua"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":47}}]}
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 9 as @e[scores={tbcID=2}] run data merge entity @s[tag=tbcCreeper] {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.creeper.default","color":"green"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":147}}]}
