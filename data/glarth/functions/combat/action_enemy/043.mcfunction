...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 41..50 run particle minecraft:lava ~ ~0.25 ~ 1 1 1 0.1 10
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 50 at @s run playsound minecraft:lava_dragon_breath1 hostile @a ~ ~ ~ 2 1
...
execute if score @s tbcAttackStage matches 1 positioned ^ ^ ^2.5 run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0.0f,Duration:2147483647,Tags:["tbcFireBarrier","tbc"]}
