...
#2
$execute if score @s tbcAttackStage matches 2 run function glarth:combat/action_enemy/stages/swipe/attack_multi {speed:$(attack_speed),block_end:$(block_end),post_block:$(post_block),next_stage:$(attack_end)}
...
$execute if score @s tbcAttackStage matches 4 as @e[scores={tbcID=2}] at @s run function glarth:combat/action_enemy/stages/swipe/attack_multi {speed:$(attack_speed),block_end:$(block_end),post_block:$(post_block),next_stage:$(attack_end)}
