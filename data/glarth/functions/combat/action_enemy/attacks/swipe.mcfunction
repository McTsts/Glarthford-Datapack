...
# execute attack
$execute if score @s tbcAttackStage matches 2 run function glarth:combat/action_enemy/stages/swipe/attack {speed:$(attack_speed),block_end:$(block_end),post_block:$(post_block),next_stage:$(attack_end)}
