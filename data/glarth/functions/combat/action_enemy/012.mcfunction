...
execute if score @s tbcAttackStage matches 2 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/stages/generic/multi_select_x
...
execute if score @s tbcAttackStage matches 4 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/stages/generic/multi_to_x {speed:0.2,next_range:0.3}
...
execute if score @s tbcAttackStage matches 5 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/stages/generic/multi_to_target {speed:0.2,next_range:2}

#6
execute if score @s tbcAttackStage matches 6 run function glarth:combat/action_enemy/stages/generic/multi_align

execute if score @s tbcAttackStage matches 6 as @e[scores={tbcID=2}] at @s run function glarth:combat/action_enemy/stages/generic/multi_to_center {speed:0.2,next_range:0.2}
...
#7
execute if score @s tbcAttackStage matches 7 as @e[scores={tbcID=2}] at @s run function glarth:combat/action_enemy/stages/generic/to_homeid {id:2,speed:0.35,next_range:0.2}

execute if score @s tbcAttackStage matches 7 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/stages/generic/to_center {speed:0.35,next_range:0.2}

#8
execute if score @s tbcAttackStage matches 8 run function glarth:combat/action_enemy/util/ready

execute if score @s tbcAttackStage matches 8 as @e[scores={tbcID=2}] at @s run function glarth:combat/action_enemy/stages/generic/multi_to_homeid {id:2,speed:0.35,next_range:0.2}

execute if score @s tbcAttackStage matches 8 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/stages/generic/multi_to_homeid {id:3,speed:0.35,next_range:0.2}
