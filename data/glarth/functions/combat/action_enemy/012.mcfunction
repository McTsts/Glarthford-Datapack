...
execute if score @s tbcAttackStage matches 6 as @e[scores={tbcID=3}] at @s if score @s tbcAttackTimer matches 16 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block stone ^ ^1 ^1 0 0 0 0 100
