# 0
execute as @s at @s run particle ash ~ ~ ~ 0.5 0.5 0.5 0.05 10
execute as @e[scores={tbcID=2}] at @s run particle ash ~ ~ ~ 0.5 0.5 0.5 0.05 10

execute if score @s tbcAttackStage matches 0 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.2 ~ ~
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 16 run scoreboard players operation infection tbcStats = @s tbcStrength
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 16 run scoreboard players operation infection tbcStats /= 20 Const
...
execute if score @s tbcAttackStage matches 4 as @e[scores={tbcID=2}] at @s if score @s tbcAttackTimer matches 16 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block stone ^ ^1 ^1 0 0 0 0 100
...
execute if score @s tbcAttackStage matches 4 as @e[scores={tbcID=2}] if score @s tbcAttackTimer matches 16 run scoreboard players operation fire tbcStats = @s tbcStrength
execute if score @s tbcAttackStage matches 4 as @e[scores={tbcID=2}] if score @s tbcAttackTimer matches 16 run scoreboard players operation fire tbcStats /= 20 Const
...
execute if score @s tbcAttackStage matches 4 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.2 ~ ~
...
execute if score @s tbcAttackStage matches 5 as @e[scores={tbcID=2}] at @s facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.2 ~ ~
execute if score @s tbcAttackStage matches 5 as @e[scores={tbcID=2}] at @s if entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud,distance=..0.2] run function glarth:combat/action_enemy/util/ready

#6
execute if score @s tbcAttackStage matches 6 as @e[scores={tbcID=2}] at @s facing entity @e[scores={tbcIDM=2}] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.2 ~ ~
execute if score @s tbcAttackStage matches 6 as @e[scores={tbcID=2}] at @s if entity @e[scores={tbcIDM=2},distance=..0.2] run function glarth:combat/action_enemy/util/done