...
execute if score @s tbcAttackStage matches 0 as @e[scores={tbcID=3},tag=!tbcReady] at @s as @e[tag=charQE,limit=1,sort=nearest] run item replace entity @s armor.head with diamond_hoe{CustomModelData:42}
