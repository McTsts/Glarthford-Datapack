...
execute if score @s tbcAttackStage matches 0 as @e[scores={tbcID=3},tag=!tbcReady] at @s as @e[tag=charQE,limit=1,sort=nearest] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=42]
...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 4 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block{block_state:{Name:"stone"}} ^ ^1 ^1 0 0 0 0 100
