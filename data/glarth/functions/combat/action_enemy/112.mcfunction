...
execute if score @s tbcAttackStage matches 2 run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=344]
...
execute if score @s tbcAttackStage matches 11 run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=345]
...
execute if score @s tbcAttackStage matches 13 run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=344]
