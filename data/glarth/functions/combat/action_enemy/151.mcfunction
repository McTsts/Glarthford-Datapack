...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 20 at @e[tag=tbcStrIronGolem,limit=1] run particle minecraft:block{block_state:{Name:"iron_block"}} ~ ~1 ~ 0.5 0.5 0.5 0.5 100
