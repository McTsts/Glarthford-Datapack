...
# MouseA 1 Spawn
execute if score @s tbcAttackStage matches 6 at @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:250}}],Tags:["tbcMouseA1","tbcMouse","tbc"]}
...
execute if score @s tbcAttackStage matches 7 as @e[tag=tbcMouseA1] at @s if entity @e[tag=tbcTargetAS,type=armor_stand,distance=..1.8] at @e[tag=tbcMarkerMiddleY] run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:250}}],Tags:["tbcMouseB1","tbcMouse","tbc"]}
...
execute if score @s tbcAttackStage matches 8 as @e[tag=tbcMouseB1] at @s if entity @e[tag=tbcTargetAS,type=armor_stand,distance=..1.8] if score @e[tag=tbcTurn,limit=1] tbcAttackTimer matches 22.. at @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:250}}],Tags:["tbcMouseA2","tbcMouse","tbc"]}
...
execute if score @s tbcAttackStage matches 9 as @e[tag=tbcMouseA2] at @s if entity @e[tag=tbcTargetAS,type=armor_stand,distance=..1.8] if score @e[tag=tbcTurn,limit=1] tbcAttackTimer matches 22.. at @e[tag=tbcMarkerMiddleY] run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:250}}],Tags:["tbcMouseB2","tbcMouse","tbc"]}
