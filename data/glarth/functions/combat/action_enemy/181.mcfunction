...
execute if score @s tbcAttackStage matches 1 if score n Random matches 1 at @e[tag=tbcMarkerEnemy1] positioned ~ ~1.7 ~ run tp @e[tag=tbcHealthBar,limit=1,sort=nearest,distance=..7] ~ ~ ~
execute if score @s tbcAttackStage matches 1 if score n Random matches 1 at @e[tag=tbcMarkerEnemy1] positioned ~ ~1.4 ~ run tp @e[tag=tbcHealthBar2,limit=1,sort=nearest,distance=..7] ~ ~ ~
execute if score @s tbcAttackStage matches 1 if score n Random matches 2 at @e[tag=tbcMarkerEnemy2] positioned ~ ~1.7 ~ run tp @e[tag=tbcHealthBar,limit=1,sort=nearest,distance=..7] ~ ~ ~
execute if score @s tbcAttackStage matches 1 if score n Random matches 2 at @e[tag=tbcMarkerEnemy2] positioned ~ ~1.4 ~ run tp @e[tag=tbcHealthBar2,limit=1,sort=nearest,distance=..7] ~ ~ ~
execute if score @s tbcAttackStage matches 1 if score n Random matches 3 at @e[tag=tbcMarkerEnemy3] positioned ~ ~1.7 ~ run tp @e[tag=tbcHealthBar,limit=1,sort=nearest,distance=..7] ~ ~ ~
execute if score @s tbcAttackStage matches 1 if score n Random matches 3 at @e[tag=tbcMarkerEnemy3] positioned ~ ~1.4 ~ run tp @e[tag=tbcHealthBar2,limit=1,sort=nearest,distance=..7] ~ ~ ~
...
execute if score @s tbcAttackStage matches 1 run scoreboard players set noEnemyA Temp 3
execute if score @s tbcAttackStage matches 1 run scoreboard players set noEnemyB Temp 3
...
execute if score @s tbcAttackStage matches 1 if score noEnemyA Temp matches 1 run function glarth:combat/init_tbc/enemy1
execute if score @s tbcAttackStage matches 1 if score noEnemyA Temp matches 2 run function glarth:combat/init_tbc/enemy2
execute if score @s tbcAttackStage matches 1 if score noEnemyA Temp matches 3 run function glarth:combat/init_tbc/enemy3
execute if score @s tbcAttackStage matches 1 if score noEnemyB Temp matches 1 run function glarth:combat/init_tbc/enemy1
execute if score @s tbcAttackStage matches 1 if score noEnemyB Temp matches 2 run function glarth:combat/init_tbc/enemy2
execute if score @s tbcAttackStage matches 1 if score noEnemyB Temp matches 3 run function glarth:combat/init_tbc/enemy3
execute if score @s tbcAttackStage matches 1 if score noEnemyA Temp matches 1 as @e[tag=tbcEnemy1,type=armor_stand] run function glarth:combat/entity/ep_fake
execute if score @s tbcAttackStage matches 1 if score noEnemyA Temp matches 2 as @e[tag=tbcEnemy2,type=armor_stand] run function glarth:combat/entity/ep_fake
execute if score @s tbcAttackStage matches 1 if score noEnemyA Temp matches 3 as @e[tag=tbcEnemy3,type=armor_stand] run function glarth:combat/entity/ep_fake
execute if score @s tbcAttackStage matches 1 if score noEnemyB Temp matches 1 as @e[tag=tbcEnemy1,type=armor_stand] run function glarth:combat/entity/ep_fake
execute if score @s tbcAttackStage matches 1 if score noEnemyB Temp matches 2 as @e[tag=tbcEnemy2,type=armor_stand] run function glarth:combat/entity/ep_fake
execute if score @s tbcAttackStage matches 1 if score noEnemyB Temp matches 3 as @e[tag=tbcEnemy3,type=armor_stand] run function glarth:combat/entity/ep_fake
