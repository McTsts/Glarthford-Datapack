...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 50 run item replace entity @s[tag=tbcCreeper] armor.head with diamond_hoe{CustomModelData:47}
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 30 run item replace entity @s[tag=tbcCreeper] armor.head with diamond_hoe{Damage:147}
