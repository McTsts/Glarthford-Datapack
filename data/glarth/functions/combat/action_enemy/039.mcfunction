...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 50 run replaceitem entity @s[tag=tbcCreeper] armor.head diamond_hoe{CustomModelData:47}
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 30 run replaceitem entity @s[tag=tbcCreeper] armor.head diamond_hoe{Damage:147}
