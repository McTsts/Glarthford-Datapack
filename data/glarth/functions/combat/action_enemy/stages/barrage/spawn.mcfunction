...
$execute if score n Random matches 1 as @e[tag=tbcTargetAS,type=armor_stand] at @s run function glarth:combat/action_enemy/stages/barrage/internal/spawn_1 {item:"$(item)"}
$execute if score n Random matches 2 as @e[tag=tbcTargetAS,type=armor_stand] at @s run function glarth:combat/action_enemy/stages/barrage/internal/spawn_2 {item:"$(item)"}
$execute if score n Random matches 3 as @e[tag=tbcTargetAS,type=armor_stand] at @s run function glarth:combat/action_enemy/stages/barrage/internal/spawn_3 {item:"$(item)"}
$execute if score n Random matches 4 as @e[tag=tbcTargetAS,type=armor_stand] at @s run function glarth:combat/action_enemy/stages/barrage/internal/spawn_4 {item:"$(item)"}
