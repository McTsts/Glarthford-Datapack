...
$execute if score @s tbcAttackTimer matches 20 run scoreboard players set r Random $(max)
execute if score @s tbcAttackTimer matches 20 run function glarth:util/rand_tbc
