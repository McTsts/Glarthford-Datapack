execute as @e[tag=tbcTNTSel,type=armor_stand] at @s run particle block{block_state:{Name:"pumpkin"}} ~ ~1 ~ 0 0 0 0.01 1
...
execute as @e[tag=tbcTNTSel,tag=func,type=armor_stand] at @s run scoreboard players set pumpkin tbcStats 3
