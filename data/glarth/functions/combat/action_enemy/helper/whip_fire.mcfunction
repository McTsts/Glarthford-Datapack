particle minecraft:flame ~ ~0.1 ~ 0 -1 0 0.03 0
...
execute unless score @s tbcAttack matches 47 as @e[tag=tbcViaAS,sort=nearest,limit=1,type=armor_stand,distance=..0.8] as @e[tag=tbcVia,limit=1] unless score @s blocking matches 1 run function glarth:combat/action/blocking_start
execute if score @s tbcAttack matches 47 as @e[tag=tbcViaAS,sort=nearest,limit=1,type=armor_stand,distance=..1.2] as @e[tag=tbcVia,limit=1] unless score @s blocking matches 1 run function glarth:combat/action/blocking_start
...
execute as @e[tag=tbcViaAS,sort=nearest,limit=1,type=armor_stand,distance=..0.3] run scoreboard players set fire tbcStats 2
...
execute if score length tbcWhip matches 1.. if score rotation tbcWhip matches 1.. run function glarth:combat/action_enemy/helper/whip_fire_rot
execute if score length tbcWhip matches 1.. unless score rotation tbcWhip matches 1.. positioned ^ ^ ^0.2 run function glarth:combat/action_enemy/helper/whip_fire