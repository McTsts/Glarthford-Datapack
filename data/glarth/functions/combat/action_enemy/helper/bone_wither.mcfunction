execute as @e[tag=tbcBoneSel,type=armor_stand,tag=!tbcBoneRan] at @s run particle smoke ~ ~1 ~ 0 0 0 0.01 1
...
execute as @e[tag=tbcBoneSel,tag=func,type=armor_stand,tag=tbcBoneRan] at @s run scoreboard players set wither tbcStats 0
execute as @e[tag=tbcBoneSel,tag=func,type=armor_stand,tag=!tbcBoneRan] at @s run scoreboard players set wither tbcStats 1
...
execute as @e[tag=tbcBoneSel,tag=func,type=armor_stand] at @s if score damage tbcStats matches 20.. run scoreboard players remove damage tbcStats 10
execute as @e[tag=tbcBoneSel,tag=func,type=armor_stand,tag=!tbcBoneRan] at @s run particle smoke ~ ~1 ~ 0 0 0 1 10
