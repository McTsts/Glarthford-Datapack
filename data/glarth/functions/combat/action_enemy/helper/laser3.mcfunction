particle minecraft:enchanted_hit ~ ~ ~ 0 0 0 0 1
...
execute if score rec Temp matches 1.. facing entity @e[tag=tbcTempMarker,limit=1] feet positioned ^ ^ ^0.15 run function glarth:combat/action_enemy/helper/laser3