execute as @e[tag=tbcBoneSel,type=armor_stand] at @s run particle ash ~ ~1 ~ 0 0 0 0.01 1
...
execute as @e[tag=tbcBoneSel,tag=func,type=armor_stand] at @s run scoreboard players set infection tbcStats 1
...
execute as @e[tag=tbcBoneSel,tag=func,type=armor_stand] at @s if score damage tbcStats matches 20.. run scoreboard players remove damage tbcStats 10
execute as @e[tag=tbcBoneSel,tag=func,type=armor_stand] at @s run particle minecraft:angry_villager ~ ~1 ~ 0 0 0 1 10
