execute as @e[tag=tbcTNTSel,type=armor_stand] at @s run particle witch ~ ~1 ~ 0 0 0 0.01 1
...
execute as @e[tag=tbcTNTSel,tag=func,type=armor_stand] at @s run scoreboard players set poison tbcStats 2
