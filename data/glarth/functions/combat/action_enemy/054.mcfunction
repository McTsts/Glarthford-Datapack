...
execute if score @s tbcAttackStage matches 3 if entity @e[tag=tbcTargetAS,tag=tbcWhipHit] unless score @s tbcAttackTimerX matches 30.. run scoreboard players set @s tbcAttackTimerX 30
