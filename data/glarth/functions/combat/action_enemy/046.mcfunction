...
execute if score @s tbcAttackStage matches 3 run function glarth:combat/action_enemy/helper/whip_fire
...
execute if score @s tbcAttackStage matches 5 unless score check tbcWhip >= rightEnd tbcWhip run tp @s ~ ~ ~ ~1 ~
execute if score @s tbcAttackStage matches 5 unless score check tbcWhip >= rightEnd tbcWhip run scoreboard players add @s tbcAttackTimer 2
execute if score @s tbcAttackStage matches 5 if score check tbcWhip >= rightEnd tbcWhip run scoreboard players remove @s tbcAttackTimer 2
...
execute if score @s tbcAttackStage matches 7 unless score check tbcWhip <= leftEnd tbcWhip run tp @s ~ ~ ~ ~-1 ~
execute if score @s tbcAttackStage matches 7 unless score check tbcWhip <= leftEnd tbcWhip run scoreboard players add @s tbcAttackTimer 2
execute if score @s tbcAttackStage matches 7 if score check tbcWhip <= leftEnd tbcWhip run scoreboard players remove @s tbcAttackTimer 2
...
execute if score @s tbcAttackStage matches 9 unless score check tbcWhip >= rightEnd tbcWhip run tp @s ~ ~ ~ ~1 ~
execute if score @s tbcAttackStage matches 9 unless score check tbcWhip >= rightEnd tbcWhip run scoreboard players add @s tbcAttackTimer 2
execute if score @s tbcAttackStage matches 9 if score check tbcWhip >= rightEnd tbcWhip run scoreboard players remove @s tbcAttackTimer 2
...
execute if score @s tbcAttackStage matches 11 run scoreboard players add @s tbcAttackTimer 5
...
execute if score @s tbcAttackStage matches 11 run scoreboard players operation length tbcWhip -= @s tbcAttackTimer
execute if score @s tbcAttackStage matches 11 run scoreboard players set dir tbcWhip 0
execute if score @s tbcAttackStage matches 11 run function glarth:combat/action_enemy/helper/whip_fire
execute if score @s tbcAttackStage matches 11 if score @s tbcAttackTimer matches 50.. as @e[tag=tbcPlayerAS] run tag @s remove tbcWhipHit
execute if score @s tbcAttackStage matches 11 if score @s tbcAttackTimer matches 50.. run function glarth:combat/action_enemy/util/next_stage

execute if score @s tbcAttackStage matches 12 facing entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud] feet rotated ~ 0 run tp @s ^ ^ ^0.2 ~ ~
execute if score @s tbcAttackStage matches 12 if entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud,distance=..0.3] run function glarth:combat/action_enemy/util/next_stage
