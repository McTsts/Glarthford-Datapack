...
execute if score @s tbcAttackStage matches 2 if score n Random matches 1 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~ ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"bone",Count:1,tag:{CustomModelData:2}}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1}
execute if score @s tbcAttackStage matches 2 if score n Random matches 1 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~45 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"bone",Count:1,tag:{CustomModelData:2}}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1}
execute if score @s tbcAttackStage matches 2 if score n Random matches 1 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~-45 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"bone",Count:1,tag:{CustomModelData:2}}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1}
execute if score @s tbcAttackStage matches 2 if score n Random matches 2..3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~22.5 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"bone",Count:1,tag:{CustomModelData:2}}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1}
execute if score @s tbcAttackStage matches 2 if score n Random matches 2..3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~-22.5 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"bone",Count:1,tag:{CustomModelData:2}}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1}
execute if score @s tbcAttackStage matches 2 if score n Random matches 3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~67.5 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"bone",Count:1,tag:{CustomModelData:2}}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1}
execute if score @s tbcAttackStage matches 2 if score n Random matches 3 as @e[tag=tbcTargetAS,type=armor_stand] at @s rotated ~-67.5 ~ run summon minecraft:armor_stand ^ ^-1 ^2.2 {ArmorItems:[{},{},{},{id:"bone",Count:1,tag:{CustomModelData:2}}],Pose:{Head:[0f,90f,0f]},Tags:["tbcBone","tbc"],Marker:1,Glowing:1}
execute if score @s tbcAttackStage matches 2 run tag @e[tag=tbcBone,limit=1,sort=random] add tbcBoneRan
execute if score @s tbcAttackStage matches 2 run data merge entity @e[tag=tbcBoneRan,limit=1] {ArmorItems:[{},{},{},{id:"coal",Count:1,tag:{CustomModelData:2}}]}
