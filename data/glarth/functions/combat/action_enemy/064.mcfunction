#0
execute if score @s tbcAttackStage matches 0 run scoreboard players set r Random 4
...
execute if score @s tbcAttackStage matches 0 run scoreboard players add fireworks tbc_firework 4
