...
execute if score @s tbcAttackStage matches 2 at @s run tp @s ~ ~ ~ ~30 ~
...
execute if score @s tbcAttackStage matches 3 run scoreboard players add @s tbcAttackTimer 7
...
execute if score @s tbcAttackStage matches 5 unless score check tbcWhip >= rightEnd tbcWhip run tp @s ~ ~ ~ ~1.7 ~
...
execute if score @s tbcAttackStage matches 7 unless score check tbcWhip <= leftEnd tbcWhip run tp @s ~ ~ ~ ~-1.7 ~
...
execute if score @s tbcAttackStage matches 9 run scoreboard players add @s tbcAttackTimer 7
...
execute if score @s tbcAttackStage matches 9 run scoreboard players operation length tbcWhip -= @s tbcAttackTimer
execute if score @s tbcAttackStage matches 9 run scoreboard players set dir tbcWhip 0
execute if score @s tbcAttackStage matches 9 run function glarth:combat/action_enemy/helper/whip_fire
execute if score @s tbcAttackStage matches 9 if score @s tbcAttackTimer matches 50.. as @e[tag=tbcPlayerAS] run tag @s remove tbcWhipHit
execute if score @s tbcAttackStage matches 9 if score @s tbcAttackTimer matches 50.. run function glarth:combat/action_enemy/util/next_stage
