...
execute if score @s tbcAttackStage matches 2 if score n Random matches 1..5 run summon minecraft:armor_stand ^ ^-2.00 ^2.0 {ArmorItems:[{},{},{},{id:"spruce_wood",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 2 if score n Random matches 2..5 run summon minecraft:armor_stand ^ ^-1.38 ^2.0 {ArmorItems:[{},{},{},{id:"spruce_wood",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 2 if score n Random matches 3..5 run summon minecraft:armor_stand ^ ^-0.76 ^2.0 {ArmorItems:[{},{},{},{id:"spruce_wood",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 2 if score n Random matches 4..5 run summon minecraft:armor_stand ^ ^-0.14 ^2.0 {ArmorItems:[{},{},{},{id:"spruce_wood",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
execute if score @s tbcAttackStage matches 2 if score n Random matches 5..5 run summon minecraft:armor_stand ^ ^0.480 ^2.0 {ArmorItems:[{},{},{},{id:"spruce_wood",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"gold"}
...
execute if score @s tbcAttackStage matches 2 as @e[tag=charQE,limit=1,sort=nearest] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=274]
...
execute if score @s tbcAttackStage matches 14 as @e[tag=charQE,limit=1,sort=nearest] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=272]
