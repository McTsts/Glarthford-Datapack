...
execute if score @s tbcAttackStage matches 14 as @s[tag=!tbcReady] run function glarth:combat/action_enemy/util/ready
...
execute if score @s tbcAttackStage matches 1 as @e[scores={tbcID=3}] at @s facing entity @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.2 ~ ~
execute if score @s tbcAttackStage matches 1 as @e[scores={tbcID=3}] at @s if entity @e[tag=tbcMarkerMiddleX,type=area_effect_cloud,distance=..0.3] run function glarth:combat/action_enemy/util/ready
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 5 as @e[scores={tbcID=3}] at @s facing entity @e[tag=tbcTargetAS,type=armor_stand] feet rotated ~ 0 run tp @s ~ ~ ~ ~ ~
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 20 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/helper/hold_bow
...
execute if score @s tbcAttackStage matches 3 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/helper/summon_arrow
execute if score @s tbcAttackStage matches 3 as @e[scores={tbcID=3}] at @s run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest]
...
execute if score @s tbcAttackStage matches 7 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/helper/summon_arrow
execute if score @s tbcAttackStage matches 7 as @e[scores={tbcID=3}] at @s run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest]
...
execute if score @s tbcAttackStage matches 11 as @e[scores={tbcID=3}] at @s run function glarth:combat/action_enemy/helper/summon_arrow
execute if score @s tbcAttackStage matches 11 as @e[scores={tbcID=3}] at @s run tp @e[tag=tbcArrowPN,type=armor_stand] ^-0.9 ^0.8 ^-1 facing entity @e[tag=tbcTargetAS,limit=1,type=armor_stand,sort=nearest]
...
# 14 - Return
execute if score @s tbcAttackStage matches 14 as @e[scores={tbcID=3}] at @s facing entity @e[scores={tbcIDM=3}] feet rotated ~ 0 run tp @s[tag=!tbcReady] ^ ^ ^0.2 ~ ~
execute if score @s tbcAttackStage matches 14 as @e[scores={tbcID=3}] at @s if entity @e[scores={tbcIDM=3},distance=..0.2] run function glarth:combat/action_enemy/util/ready
...
execute if score @s tbcAttackStage matches 14 as @e[scores={tbcID=2}] at @s if entity @e[scores={tbcIDM=2},distance=..0.2] run function glarth:combat/action_enemy/util/ready
