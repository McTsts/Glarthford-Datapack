...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 20 at @e[tag=tbcStrSnowGolem,limit=1] run particle minecraft:block{block_state:{Name:"snow"}} ~ ~1 ~ 0.5 0.5 0.5 0.5 100
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 20 run function glarth:dialogue/snow_golem/lines/attack1
