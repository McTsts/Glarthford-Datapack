...
execute if score @s tbcAttackStage matches 1 run tag @e[tag=tbcStrIronGolem,limit=1] remove stage_024
execute if score @s tbcAttackStage matches 1 run tag @e[tag=tbcStrIronGolem,limit=1] remove death_015
execute if score @s tbcAttackStage matches 1 run tag @e[tag=tbcStrIronGolem,limit=1] add stage_025
