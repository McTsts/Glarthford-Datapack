...
# Swipe
execute if score @s tbcAttackStage matches 4 unless entity @s[tag=tbcPiglin] as @e[tag=charQE,limit=1,sort=nearest] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=4]
execute if score @s tbcAttackStage matches 4 if entity @s[tag=tbcPiglin] as @e[tag=charQE,limit=1,sort=nearest] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=508]
