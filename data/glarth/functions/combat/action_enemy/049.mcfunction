...
execute if score @s tbcAttackStage matches 1 if score n Random matches 1..8 run summon minecraft:armor_stand ^ ^-2.00 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 2..8 run summon minecraft:armor_stand ^ ^-1.38 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 3..8 run summon minecraft:armor_stand ^ ^-0.76 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 4..8 run summon minecraft:armor_stand ^ ^-0.14 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 5..8 run summon minecraft:armor_stand ^ ^0.480 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 6..8 run summon minecraft:armor_stand ^ ^1.100 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 7..8 run summon minecraft:armor_stand ^ ^1.720 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 if score n Random matches 8..8 run summon minecraft:armor_stand ^ ^2.34 ^2.7 {ArmorItems:[{},{},{},{id:"slime_block",count:1}],Pose:{Head:[0.0f,90.0f,0.0f]},Tags:["tbcTNT","tbc"],Marker:1,Glowing:1,NoGravity:1,Invulnerable:1,Fire:10000s,Team:"green"}
execute if score @s tbcAttackStage matches 1 as @s[tag=tbcEnderPriest] run item replace entity @e[tag=tbcTNT] armor.head with minecraft:slime_block[custom_model_data=1]
