...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 15 run playsound minecraft:entity.chicken.ambient neutral @a ~ ~ ~ 1 1.5
...
execute if score @s tbcAttackStage matches 5 if entity @e[tag=tbcSelMarker,distance=..0.3] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:344}
