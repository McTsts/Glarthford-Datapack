...
execute if score @s tbcAttackStage matches 3 if score @s tbcAttackTimer matches 5 run data merge entity @e[tag=tbcTargetAS,limit=1] {Motion:[0.0,0.65,0.0],NoGravity:0}
...
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 01 run item replace entity @s armor.head with netherite_axe{CustomModelData:31}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 02 run item replace entity @s armor.head with netherite_axe{CustomModelData:30}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 03 run item replace entity @s armor.head with netherite_axe{CustomModelData:29}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 04 run item replace entity @s armor.head with netherite_axe{CustomModelData:28}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 05 run item replace entity @s armor.head with netherite_axe{CustomModelData:27}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 06 run item replace entity @s armor.head with netherite_axe{CustomModelData:26}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 07 run item replace entity @s armor.head with netherite_axe{CustomModelData:25}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 08 run item replace entity @s armor.head with netherite_axe{CustomModelData:24}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 09 run item replace entity @s armor.head with netherite_axe{CustomModelData:23}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 10 run item replace entity @s armor.head with netherite_axe{CustomModelData:22}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 11 run item replace entity @s armor.head with netherite_axe{CustomModelData:21}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 12 run item replace entity @s armor.head with netherite_axe{CustomModelData:20}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 13 run item replace entity @s armor.head with netherite_axe{CustomModelData:19}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 14 run item replace entity @s armor.head with netherite_axe{CustomModelData:18}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 15 run item replace entity @s armor.head with netherite_axe{CustomModelData:17}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 16 run item replace entity @s armor.head with netherite_axe{CustomModelData:16}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 17 run item replace entity @s armor.head with netherite_axe{CustomModelData:15}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 18 run item replace entity @s armor.head with netherite_axe{CustomModelData:14}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 19 run item replace entity @s armor.head with netherite_axe{CustomModelData:13}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 20 run item replace entity @s armor.head with netherite_axe{CustomModelData:12}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 21 run item replace entity @s armor.head with netherite_axe{CustomModelData:11}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 22 run item replace entity @s armor.head with netherite_axe{CustomModelData:10}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 23 run item replace entity @s armor.head with netherite_axe{CustomModelData:9}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 24 run item replace entity @s armor.head with netherite_axe{CustomModelData:8}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 25 run item replace entity @s armor.head with netherite_axe{CustomModelData:7}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 26 run item replace entity @s armor.head with netherite_axe{CustomModelData:6}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 27 run item replace entity @s armor.head with netherite_axe{CustomModelData:5}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 28 run item replace entity @s armor.head with netherite_axe{CustomModelData:4}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 29 run item replace entity @s armor.head with netherite_axe{CustomModelData:3}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 30 run item replace entity @s armor.head with netherite_axe{CustomModelData:2}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 31 run item replace entity @s armor.head with netherite_axe{CustomModelData:1}
execute if score @s tbcAttackStage matches 5..6 if score @s tbcAttackTimer matches 32 run item replace entity @s armor.head with diamond_hoe{CustomModelData:524}
