...
execute if score @s tbcAttackStage matches 6 if entity @e[tag=tbcTempMarker,distance=..2.5,type=area_effect_cloud] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:249}
...
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 17 run replaceitem entity @s armor.head diamond_hoe{Damage:119}
...
execute if score @s tbcAttackStage matches 9 if entity @e[tag=tbcSelMarker,distance=..0.2,type=area_effect_cloud] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:223}
