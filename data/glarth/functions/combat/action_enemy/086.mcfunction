...
execute if score @s tbcAttackStage matches 0 at @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":279}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.zombie.baby","color":"dark_green"}',Tags:["tbcAttackDummy"]}
execute if score @s tbcAttackStage matches 0 at @e[tag=tbcMarkerMiddleY] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":279}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.zombie.baby","color":"dark_green"}',Tags:["tbcAttackDummy"]}
...
execute if score @s tbcAttackStage matches 1 as @e[tag=tbcAttackDummy] at @s run particle block{block_state:{Name:"dirt"}} ~ ~ ~ 0.3 0.1 0.3 0.1 10
...
execute if score @s tbcAttackStage matches 6 if entity @e[tag=tbcTempMarker,distance=..2.5,type=area_effect_cloud] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=249]
...
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 14 if score @e[tag=tbcTarget,limit=1] blocked matches 0 run particle minecraft:block{block_state:{Name:"stone"}} ^ ^1 ^1 0 0 0 0 100
...
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 17 run item replace entity @s armor.head with minecraft:diamond_hoe[damage=119]
...
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 17 at @e[tag=tbcMarkerMiddleX,type=area_effect_cloud] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":279}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.zombie.baby","color":"dark_green"}',Tags:["tbcAttackDummy"]}
execute if score @s tbcAttackStage matches 7 if score @s tbcAttackTimer matches 17 at @e[tag=tbcMarkerMiddleY] positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":279}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.zombie.baby","color":"dark_green"}',Tags:["tbcAttackDummy"]}
...
execute if score @s tbcAttackStage matches 8 as @e[tag=tbcAttackDummy] at @s run particle block{block_state:{Name:"dirt"}} ~ ~ ~ 0.3 0.1 0.3 0.1 10
...
execute if score @s tbcAttackStage matches 9 if entity @e[tag=tbcSelMarker,distance=..0.2,type=area_effect_cloud] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=223]
