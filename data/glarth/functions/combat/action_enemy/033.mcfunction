...
execute if score @s tbcAttackStage matches 0 if entity @e[tag=tbcMarkerMiddle,type=area_effect_cloud,distance=..0.3] run item replace entity @s armor.head with minecraft:diamond_hoe[custom_model_data=43]
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 17 run item replace entity @s armor.head with minecraft:diamond_hoe[damage=39]
