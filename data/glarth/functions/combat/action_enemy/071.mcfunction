...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 01 run data merge entity @s[tag=tbcShulker] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.shulker","color":"dark_purple"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:205}}]}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 01 run data merge entity @s[tag=tbcShulkerFake] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.ender_priest.shulker","color":"dark_purple"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:205}}]}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 01 run data merge entity @s[tag=tbcShulkerGuardian] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.crystal_guardian","color":"gold"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:419}}]}
...
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 45 run data merge entity @s[tag=tbcShulker] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.shulker","color":"dark_purple"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:206}}]}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 45 run data merge entity @s[tag=tbcShulkerFake] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.ender_priest.shulker","color":"dark_purple"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:206}}]}
execute if score @s tbcAttackStage matches 0 if score @s tbcAttackTimer matches 45 run data merge entity @s[tag=tbcShulkerGuardian] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.crystal_guardian","color":"gold"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:420}}]}
...
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 45 run data merge entity @s[tag=tbcShulker] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.shulker","color":"dark_purple"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:205}}]}
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 45 run data merge entity @s[tag=tbcShulkerFake] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.ender_priest.shulker","color":"dark_purple"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:205}}]}
execute if score @s tbcAttackStage matches 2 if score @s tbcAttackTimer matches 45 run data merge entity @s[tag=tbcShulkerGuardian] {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.crystal_guardian","color":"gold"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:419}}]}
