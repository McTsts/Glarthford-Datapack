execute if entity @e[tag=tbcTurn,type=!player] run tellraw @a ["",[{"nbt":"ArmorItems[0].components.minecraft:custom_data.CustomName","entity":"@e[tag=tbcTurn,type=!player]","interpret":true}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.death1","with":[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}]}]
execute unless entity @e[tag=tbcTurn,type=!player] run tellraw @a ["",[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@e[type=player,tag=tbcTurn]","interpret":true}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.death1","with":[{"nbt":"EnderItems[{Slot:0b}].components.minecraft:custom_data.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}]}]
