...
execute if score difficulty tbcStats matches 6 run scoreboard players set @s tbcEscape 5

execute if score difficulty tbcStats matches 0 run scoreboard players set @s tbcStrength 10
...
execute if score difficulty tbcStats matches 6 run scoreboard players set @s tbcStrength 50
...
execute if score difficulty tbcStats matches 0 run scoreboard players set @s tbcHealth 30
...
execute if score difficulty tbcStats matches 6 run scoreboard players set @s tbcArmor 15
...
execute if score difficulty tbcStats matches 0 run function glarth:combat/entity/implements/nerf/1
execute if score difficulty tbcStats matches 0 run function glarth:combat/entity/implements/nerf/2
execute if score difficulty tbcStats matches 0 run function glarth:combat/entity/implements/nerf/3
execute if score difficulty tbcStats matches 0 run function glarth:combat/entity/implements/nerf/4
