...
data merge entity @s {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.skeleton.default","color":"white"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":22}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.skeleton.default","color":"white"}'}
