...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.companion.wolf","color":"gray"}'}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.companion.wolf\",\"color\":\"gray\"}"}
