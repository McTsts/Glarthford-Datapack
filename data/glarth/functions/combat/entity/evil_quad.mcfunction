...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.evil_quad","color":"gray"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:529}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.evil_quad\",\"color\":\"gray\"}"}
