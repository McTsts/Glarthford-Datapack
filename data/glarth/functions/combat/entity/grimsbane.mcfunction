...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.boss.grimsbane","color":"dark_gray"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{Damage:72}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.boss.grimsbane\",\"color\":\"dark_gray\"}"}
execute if entity b249813e-68b2-4549-9057-a4af4b21203e run data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.grimsbane.taco","color":"gold"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:347}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.grimsbane.taco\",\"color\":\"gold\"}"}
execute if entity 8069e003-c654-4077-937f-45a017a1321b run data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.grimsbane.taco","color":"gold"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:347}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.grimsbane.taco\",\"color\":\"gold\"}"}
execute if entity 1c361569-6b3e-4ab0-b27f-b9f0df43f336 run data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.grimsbane.taco","color":"gold"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:347}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.grimsbane.taco\",\"color\":\"gold\"}"}
