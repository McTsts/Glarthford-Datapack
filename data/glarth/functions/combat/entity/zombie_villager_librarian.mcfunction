...
data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.zombie.villager","color":"dark_green"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:537}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.zombie.villager\",\"color\":\"dark_green\"}"}
#Spawn
