...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.zombie.ghost_mayor","color":"white"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":521}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.zombie.ghost_mayor","color":"white"}',Team:"aqua"}
