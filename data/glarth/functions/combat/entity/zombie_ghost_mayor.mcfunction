...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.zombie.ghost","color":"white"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:521}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.zombie.ghost\",\"color\":\"white\"}",Team:"aqua"}
