...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.ally.explorer","color":"#8C5800"}',NoColor:'{"translate":"tbc.ally.explorer"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":52}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.ally.explorer","color":"#8C5800"}'}
