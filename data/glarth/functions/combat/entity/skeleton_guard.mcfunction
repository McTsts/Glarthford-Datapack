...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.skeleton.guard","color":"gray"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:177}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.skeleton.guard\",\"color\":\"gray\"}"}
