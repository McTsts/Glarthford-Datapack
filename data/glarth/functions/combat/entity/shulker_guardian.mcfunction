...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.enemy.crystal_guardian","color":"gold"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":419}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.enemy.crystal_guardian","color":"gold"}'}
