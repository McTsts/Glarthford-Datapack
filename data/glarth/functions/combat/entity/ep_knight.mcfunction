...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",Count:1,tag:{CustomName:'{"translate":"tbc.short_name.enemy.ender_priest.ender_knight","color":"dark_purple"}'}},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:359}}],CustomNameVisible:1,CustomName:"{\"translate\":\"tbc.enemy.ender_priest.ender_knight\",\"color\":\"dark_purple\"}"}
