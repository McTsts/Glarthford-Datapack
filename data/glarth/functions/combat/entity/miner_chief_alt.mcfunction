...
#Overwrite
data merge entity @s {ArmorItems:[{id:"stone",count:1,components:{"minecraft:custom_data":{CustomName:'{"translate":"tbc.short_name.ally.chief","color":"white"}',NoColor:'{"translate":"tbc.ally.chief"}'}}},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":176}}],CustomNameVisible:1,CustomName:'{"translate":"tbc.ally.chief","color":"white"}'}
