...
tag @s remove stage_035

# special attacks
scoreboard players set @s attack_181 2
...
function glarth:combat/action_enemy/187_init

# Stage
tag @s remove tbcEnderMorphed

# Dialogue
function glarth:dialogue/ender_priest/lines/attack1
