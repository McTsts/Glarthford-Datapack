...
execute if score difficulty tbcStats matches 4..5 if score @s tbcArmor matches 40.. run tag @s add stage_074
execute if score difficulty tbcStats matches 4..5 if score @s tbcArmor matches ..40 run scoreboard players add @s tbcArmor 05
tag @s add stage_064