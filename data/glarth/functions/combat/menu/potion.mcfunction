...
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. run scoreboard players set @s lastAttack 6
...
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. if score attackType tbcStats matches 3 run scoreboard players set @s lastAttackData 2
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. if score attackType tbcStats matches 4 run scoreboard players set @s lastAttackData 1
...
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. if score attackType tbcStats matches 9 run scoreboard players set @s lastAttack 8
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. if score attackType tbcStats matches 9 run scoreboard players set @s lastAttackData 0
...
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. if score attackType tbcStats matches 9 run tellraw @a ["",[{"nbt":"EnderItems[{Slot:0b}].tag.name","entity":"@s[type=player]","interpret":true},{"selector":"@s[type=!player]"}],{"text":" >> ","color":"gray"},{"translate":"tbc.msg.use","with":[{"translate":"tbc.attack.potion.wind","bold":true}]}]
...
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. if score attackType tbcStats matches 9 run function glarth:combat/action/thunder_init
execute as @s[scores={tbcCarrot=1..}] if score T tbcAttackParamX matches 1.. unless score attackType tbcStats matches 9 run function glarth:combat/done
