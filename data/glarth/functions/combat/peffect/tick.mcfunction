...
execute if score eId Temp matches 16 run data remove storage glarth:main eff[{Id:16b}]
execute if score eId Temp matches 18 run data remove storage glarth:main eff[{Id:18b}]
