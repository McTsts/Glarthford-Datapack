...
execute as @r[tag=inTBC] at @s if entity @a[distance=0.1..,tag=inTBC] run tellraw @a ["\n",{"translate":"tbc","bold":true,"color":"gold"},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.win.mp","color":"gold","with":[{"block":"84 26 -123","nbt":"front_text.messages[0]","interpret":true,"color":"gold"}]}]
execute as @r[tag=inTBC] at @s unless entity @a[distance=0.1..,tag=inTBC] unless entity @e[tag=tbcAlly] run tellraw @a ["\n",{"translate":"tbc","bold":true,"color":"gold"},{"text":" >> ","color":"gray"},{"translate":"tbc.msg.win.sp","color":"gold","with":[{"block":"84 26 -123","nbt":"front_text.messages[0]","interpret":true,"color":"gold"}]}]
