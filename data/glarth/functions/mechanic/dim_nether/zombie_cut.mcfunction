...
execute if entity @s[tag=doI] if score @s action matches 100 as @e[tag=piglin1] run item replace entity @s armor.head with diamond_hoe{CustomModelData:483}
...
execute if entity @s[tag=doI] if score @s action matches 120 as @e[tag=piglin3] run item replace entity @s armor.head with diamond_hoe{CustomModelData:484}
...
execute if entity @s[tag=doI] if score @s action matches 140 as @e[tag=piglin4] run item replace entity @s armor.head with diamond_hoe{CustomModelData:485}
...
execute if entity @s[tag=doI] if score @s action matches 160 as @e[tag=piglin5] run item replace entity @s armor.head with diamond_hoe{CustomModelData:486}
...
execute if entity @s[tag=doI] if score @s action matches 180 as @e[tag=piglin2] run item replace entity @s armor.head with diamond_hoe{CustomModelData:475}
