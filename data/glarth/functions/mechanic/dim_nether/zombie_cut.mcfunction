...
execute if entity @s[tag=doI] if score @s action matches 100 as @e[tag=piglin1] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:483}
...
execute if entity @s[tag=doI] if score @s action matches 120 as @e[tag=piglin3] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:484}
...
execute if entity @s[tag=doI] if score @s action matches 140 as @e[tag=piglin4] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:485}
...
execute if entity @s[tag=doI] if score @s action matches 160 as @e[tag=piglin5] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:486}
...
execute if entity @s[tag=doI] if score @s action matches 180 as @e[tag=piglin2] run replaceitem entity @s armor.head diamond_hoe{CustomModelData:475}
