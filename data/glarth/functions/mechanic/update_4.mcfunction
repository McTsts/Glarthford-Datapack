...
#Tip 3
tag @a[tag=!tip3,nbt={Inventory:[{components:{"minecraft:custom_data":{pot:1}}}]}] add haspot 
execute as @a[tag=haspot,tag=!tip3] run function glarth:mechanic/tip/3
tag @a[tag=haspot] remove haspot

#Tip 7
tag @a[tag=!tip7,nbt={Inventory:[{components:{"minecraft:custom_data":{pot:2}}}]}] add haspot2
execute as @a[tag=haspot2,tag=!tip7] run function glarth:mechanic/tip/7
tag @a[tag=haspot2] remove haspot2

#Tip 8
tag @a[tag=!tip8,nbt={Inventory:[{components:{"minecraft:custom_data":{pot:3}}}]}] add haspot3
