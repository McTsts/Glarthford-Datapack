...
summon slime ~ ~2.0 ~ {PersistenceRequired:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Size:0,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0,show_particles:0b}],Attributes:[{Name:"generic.follow_range",Base:0},{Name:"generic.knockback_resistance",Base:10000},{Name:"generic.movement_speed",Base:0},{Name:"generic.attack_damage",Base:0},{Name:"generic.attack_knockback",Base:0}],Tags:["appleSlime","appleSlimeNew"]}
