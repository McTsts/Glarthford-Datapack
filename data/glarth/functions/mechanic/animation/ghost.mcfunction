...
execute if score n Random matches 1 at @s rotated ~ 0 positioned ^ ^ ^20 positioned ~ ~-3 ~ run summon minecraft:armor_stand ~ ~ ~ {Tags:["ghost_up","ghost_upNew"],Invisible:1,Marker:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":194}}],Invulnerable:1,Fire:1000s}
execute if score n Random matches 2 at @s rotated ~ 0 positioned ^ ^ ^20 positioned ~ ~-3 ~ run summon minecraft:armor_stand ~ ~ ~ {Tags:["ghost_up","ghost_upNew"],Invisible:1,Marker:1,ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:custom_model_data":195}}],Invulnerable:1,Fire:1000s}
