...
execute if score n Random matches 1 if entity @s[tag=bobUp] at @s run tp @s ~ ~-0.04 ~
execute if score n Random matches 1 unless entity @s[tag=bobUp] at @s run tp @s ~ ~0.04 ~
