...
execute if score @s frogAnimation matches 2 run data merge entity @s {ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:119}}]}
execute if score @s frogAnimation matches 4 run data merge entity @s {ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:118}}]}
execute if score @s frogAnimation matches 10 run data merge entity @s {ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:119}}]}
execute if score @s frogAnimation matches 12 run data merge entity @s {ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:120}}]}
...
execute as @e[type=cod,distance=..1,sort=nearest,limit=1,tag=frogSwimmingFish] at @s if block ~ ~2 ~ water run data merge entity @s {Motion:[0.0,0.5,0.0],NoGravity:0,Marker:0}