summon armor_stand ~ 26.3 ~ {id:"armor_stand",ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:48}}],Tags:["frog","frogSwimming","frogSwimmingNew","die4"],Invulnerable:1b,DisabledSlots:4144959,Invisible:1}
