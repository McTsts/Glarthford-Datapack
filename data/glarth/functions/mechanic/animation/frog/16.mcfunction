...
execute if score @s Animation matches 10 run data merge entity @s {Motion:[0.0d,0.4d,0.0d],NoGravity:0,Marker:0}
...
execute if score @s Animation matches 100.. run scoreboard players set @s Animation 0