...
execute positioned 15 32 -211 if entity @s[distance=..0.2] if score @s lavaDragonAnim matches 1 run summon minecraft:falling_block 14 33 -211 {Time:0,Motion:[0.0,1.0,0.2],BlockState:{Name:"minecraft:oak_slab",Properties:{type:"bottom",waterlogged:"false"}},Tags:["falling_block_kill"]}
execute positioned 15 32 -211 if entity @s[distance=..0.2] if score @s lavaDragonAnim matches 1 run summon minecraft:falling_block 15 33 -211 {Time:0,Motion:[0.5,0.8,0.3],BlockState:{Name:"minecraft:jungle_stairs",Properties:{facing:"north",half:"bottom",shape:"straight",waterlogged:"false"}},Tags:["falling_block_kill"]}
execute positioned 15 32 -211 if entity @s[distance=..0.2] if score @s lavaDragonAnim matches 1 run summon minecraft:falling_block 16 33 -211 {Time:0,Motion:[0.0,0.8,0.5],BlockState:{Name:"minecraft:jungle_stairs",Properties:{facing:"north",half:"bottom",shape:"straight",waterlogged:"false"}},Tags:["falling_block_kill"]}
execute positioned 15 32 -211 if entity @s[distance=..0.2] if score @s lavaDragonAnim matches 1 run summon minecraft:falling_block 14 32 -211 {Time:0,Motion:[0.4,0.8,0.7],BlockState:{Name:"minecraft:oak_planks"},Tags:["falling_block_kill"]}
execute positioned 15 32 -211 if entity @s[distance=..0.2] if score @s lavaDragonAnim matches 1 run summon minecraft:falling_block 15 32 -211 {Time:0,Motion:[0.4,0.7,0.35],BlockState:{Name:"minecraft:oak_planks"},Tags:["falling_block_kill"]}
execute positioned 15 32 -211 if entity @s[distance=..0.2] if score @s lavaDragonAnim matches 1 run summon minecraft:falling_block 16 32 -211 {Time:0,Motion:[0.4,0.8,0.6],BlockState:{Name:"minecraft:oak_planks"},Tags:["falling_block_kill"]}
