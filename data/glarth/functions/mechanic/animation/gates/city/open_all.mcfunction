...
execute unless block -20 26 -198 air run summon minecraft:armor_stand -19.5 26.0 -195.5 {ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":144}}],Marker:1b,Invisible:1b,NoGravity:1b,Tags:["gate","gate_west"],Rotation:[90.0f,0.0f],Silent:1b}
execute unless block -20 26 -198 air run fill -20 26 -198 -20 31 -194 jungle_fence replace minecraft:spruce_fence

execute unless block 34 26 -198 air run summon minecraft:armor_stand 34.5 26.0 -195.5 {ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":144}}],Marker:1b,Invisible:1b,NoGravity:1b,Tags:["gate","gate_east"],Rotation:[90.0f,0.0f],Silent:1b}
