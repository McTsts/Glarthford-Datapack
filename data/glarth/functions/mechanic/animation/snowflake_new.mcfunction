...
execute at @s if score n Random matches 5 run tp @s ~ ~ ~-2
execute at @s if score n Random matches 6 run tp @s ~ ~ ~-3
execute at @s run summon minecraft:armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":165}}],Invisible:1,Small:1,ActiveEffects:[{Id:28,Duration:999999,ShowParticles:0b}],Tags:["snowflake","snowflakeNA"],Pose:{Head:[0.0f,0.0f,90.0f]},Rotation:[0.1f,0.0f]}
kill @s