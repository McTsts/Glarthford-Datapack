execute as @e[tag=diamond] run give @a[x=-6,y=26,z=-149,distance=..1,gamemode=adventure] diamond 
...
execute as @e[tag=flint] run give @a[x=73,y=25,z=-269,distance=..1,gamemode=adventure] flint
execute as @a[x=73,y=25,z=-269,distance=..1,gamemode=adventure] at @s run kill @e[tag=flint]
execute as @a[x=73,y=25,z=-269,distance=..1,gamemode=adventure] at @s run kill @e[tag=pickup_name,limit=1,sort=nearest,distance=..3.5]

execute as @e[tag=coal] run give @a[x=71,y=24,z=-275,distance=..1,gamemode=adventure] coal
...
execute as @e[tag=mushroom1] run give @a[x=-51,y=27,z=-220,distance=..1,gamemode=adventure] brown_mushroom
execute as @a[x=-51,y=27,z=-220,distance=..1,gamemode=adventure] at @s run kill @e[tag=mushroom1]
execute as @a[x=-51,y=27,z=-220,distance=..1,gamemode=adventure] at @s run kill @e[tag=pickup_name,limit=1,sort=nearest,distance=..3.5]

execute as @e[tag=mushroom2] run give @a[x=-44,y=27,z=-214,distance=..1,gamemode=adventure] brown_mushroom
execute as @a[x=-44,y=27,z=-214,distance=..1,gamemode=adventure] at @s run kill @e[tag=mushroom2]
execute as @a[x=-44,y=27,z=-214,distance=..1,gamemode=adventure] at @s run kill @e[tag=pickup_name,limit=1,sort=nearest,distance=..3.5]

execute as @e[tag=saddle] run give @a[x=-62,y=31,z=-252,distance=..1,gamemode=adventure] saddle
execute as @a[x=-62,y=31,z=-252,distance=..1,gamemode=adventure] at @s run kill @e[tag=saddle]
execute as @a[x=-62,y=31,z=-252,distance=..1,gamemode=adventure] at @s run kill @e[tag=pickup_name,limit=1,sort=nearest,distance=..3.5]