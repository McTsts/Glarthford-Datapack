...
execute if score winMessage Stats matches 1 run tellraw @a ["",{"translate":"victory","color":"green"},{"text":"\n"},{"translate":"time.ingame","color":"green","with":[{"nbt":"time.hour","storage":"glarth:main","interpret":true,"color":"green","bold":true},{"text":":","color":"green","bold":true},{"nbt":"time.minute","storage":"glarth:main","interpret":true,"color":"green","bold":true},{"nbt":"time.day","storage":"glarth:main","interpret":true,"color":"green","bold":true}]},{"text":"\n"},{"translate":"time.actual","color":"green","with":[{"nbt":"time.a_hour","storage":"glarth:main","interpret":true,"color":"green","bold":true},{"text":":","color":"green","bold":true},{"nbt":"time.a_minute","storage":"glarth:main","interpret":true,"color":"green","bold":true},{"nbt":"time.a_sec","storage":"glarth:main","interpret":true,"color":"green","bold":true}]},{"text":"\n"},{"translate":"stories","color":"green"}]
execute if score winMessage Stats matches 2 run tellraw @a ["",{"translate":"victory2","color":"aqua"},{"text":"\n"},{"translate":"time.ingame","color":"aqua","with":[{"nbt":"time.hour","storage":"glarth:main","interpret":true,"color":"aqua","bold":true},{"text":":","color":"aqua","bold":true},{"nbt":"time.minute","storage":"glarth:main","interpret":true,"color":"aqua","bold":true},{"nbt":"time.day","storage":"glarth:main","interpret":true,"color":"aqua","bold":true}]},{"text":"\n"},{"translate":"time.actual","color":"aqua","with":[{"nbt":"time.a_hour","storage":"glarth:main","interpret":true,"color":"aqua","bold":true},{"text":":","color":"aqua","bold":true},{"nbt":"time.a_minute","storage":"glarth:main","interpret":true,"color":"aqua","bold":true},{"nbt":"time.a_sec","storage":"glarth:main","interpret":true,"color":"aqua","bold":true}]},{"text":"\n"},{"translate":"stories2","color":"aqua"}]
scoreboard players set winMessage Stats 1
