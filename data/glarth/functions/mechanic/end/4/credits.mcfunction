...
execute if score timer end matches 555 run summon area_effect_cloud 7 36 -204 {Rotation:[0.0f,5.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
...
execute if score timer end matches 6660 run summon area_effect_cloud 7 27.5 -205 {Rotation:[0.0f,15.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
# Construct
...
execute if score timer end matches 6754 positioned 7 26 -202 run summon armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":71,"minecraft:unbreakable":{}}}],Tags:["end_scene","citizen"],Rotation:[180.0f,0.0f]}
...
execute if score timer end matches 1800 run summon area_effect_cloud 54.0 31.5 -277.5 {Rotation:[-130.0f,15.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
execute if score timer end matches 1800 run setblock 56 29 -276 stone
execute if score timer end matches 1800 run summon wolf 56 30 -276 {Tags:["end_scene","adriWolf"],NoAI:1,Silent:1b,Rotation:[180.0f,0.0f]}
# Wolf
...
execute if score timer end matches 1850 run data merge entity @e[tag=adri,limit=1] {Motion:[0.0d,0.1d,0.0d]}
execute if score timer end matches 1870 run data merge entity @e[tag=adri,limit=1] {Motion:[0.0d,0.1d,0.0d]}
execute if score timer end matches 1890 run data merge entity @e[tag=adri,limit=1] {Motion:[0.0d,0.1d,0.0d]}
execute if score timer end matches 1910 run data merge entity @e[tag=adri,limit=1] {Motion:[0.0d,0.1d,0.0d]}
# Reset
...
execute if score timer end matches 2960 run summon area_effect_cloud 28.5 28.5 -132.5 {Rotation:[-150.0f,20.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
# Bee Explosin
...
execute if score timer end matches 4100 run summon area_effect_cloud -47.5 30.5 -259.5 {Rotation:[-130.0f,20.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
# Crow
execute if score timer end matches 4120 run summon minecraft:armor_stand -43 28 -263 {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":158}}],Tags:["crow","crowPeck","end_scene"],Rotation:[40.0f,0.0f]}
...
execute if score timer end matches 5180 run summon area_effect_cloud 14.0 28.0 -266.5 {Rotation:[120.0f,10.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
# Notes
...
execute if score timer end matches 7000 run summon area_effect_cloud 23.0 28.0 -175.5 {Rotation:[-70.0f,15.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
#End
...
execute if score timer end matches 8000 run summon area_effect_cloud -87.44 42.00 -244.93 {Rotation:[-70.0f,8.0f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
# TImed
execute if score timer end matches 8070 at @e[tag=suso] run particle cloud ~ ~ ~ 0.3 0.3 0.3 0.1 10
execute if score timer end matches 8070 at @e[tag=suso] run summon cat ~ ~ ~ {CatType:3,Sitting:1,Invulnerable:1,NoAI:1,Rotation:[120.0f,0.0f],CustomName:'{"translate":"suso","color":"blue"}',CustomNameVisible:1,Tags:["suso"]}
