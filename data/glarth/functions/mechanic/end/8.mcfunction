...
execute if score timer end matches 1 run summon area_effect_cloud -8 28 -203 {Rotation:[90f,20f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
