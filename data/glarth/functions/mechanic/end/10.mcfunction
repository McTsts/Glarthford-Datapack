...
execute if score timer end matches 1 if score allyGibbs Stats matches 1 run summon armor_stand 171 26 -156 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",Count:1b},{id:"minecraft:chainmail_chestplate",Count:1b},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:348,Unbreakable:1}}],Tags:["char","gibbs","end_scene"],Rotation:[120f,0f],CustomName:"{\"translate\":\"gibbs\",\"color\":\"gray\"}",CustomNameVisible:1}
execute if score timer end matches 1 if score allyJerozgen Stats matches 1 run summon armor_stand 168 26 -162 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",Count:1b},{id:"minecraft:chainmail_chestplate",Count:1b},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:525,Unbreakable:1}}],Tags:["char","jerozgen","end_scene"],Rotation:[-15f,0f],CustomName:"{\"translate\":\"jerozgen\",\"color\":\"gold\"}",CustomNameVisible:1}
execute if score timer end matches 1 if score allyTs Stats matches 1 run summon armor_stand 172 26 -158 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",Count:1b},{id:"minecraft:chainmail_chestplate",Count:1b},{id:"minecraft:diamond_hoe",Count:1b,tag:{Damage:1,Unbreakable:1}}],Tags:["char","mctsts","end_scene"],Rotation:[95f,0f],CustomName:'{"translate":"mctsts","color":"green"}',CustomNameVisible:1}
execute if score timer end matches 1 if score allyAdri Stats matches 1 run summon armor_stand 172 26 -160 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",Count:1b},{id:"minecraft:chainmail_chestplate",Count:1b},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:256,Unbreakable:1}}],Tags:["char","adri","end_scene"],Rotation:[80f,0f],CustomName:'{"translate":"adri","color":"red"}',CustomNameVisible:1}
execute if score timer end matches 1 if score allySuso Stats matches 1 run summon armor_stand 170 26 -161 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",Count:1b},{id:"minecraft:chainmail_chestplate",Count:1b},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:360,Unbreakable:1}}],Tags:["char","suso","char_look","end_scene"],Rotation:[0f,0f],CustomName:'{"translate":"suso","color":"blue"}',CustomNameVisible:1}
execute if score timer end matches 1 run summon minecraft:armor_stand 167 26 -158 {DisabledSlots:4144959,Rotation:[-110f,0f],Passengers:[{DisabledSlots:4144959,Invisible:1,NoGravity:1,Silent:1b,Marker:1,id:"armor_stand",ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{CustomModelData:1}}],Tags:["charQ","charQ1","end_scene"],Rotation:[-110f,0f]},{DisabledSlots:4144959,Invisible:1,NoGravity:1,Silent:1b,Marker:1,id:"armor_stand",Tags:["charQ","charQ2","end_scene"],Rotation:[-110f,0f]},{DisabledSlots:4144959,Invisible:1,NoGravity:1,Silent:1b,Marker:1,id:"armor_stand",Tags:["charQ","charQ3","end_scene"],Rotation:[-110f,0f]},{DisabledSlots:4144959,Invisible:1,NoGravity:1,Silent:1b,Marker:1,id:"armor_stand",Tags:["charQ","charQ4","end_scene"],Rotation:[-110f,0f],Pose:{RightArm:[0.0f,0.0f,0.0f]}}],Tags:["charQB","end_scene"],CustomNameVisible:1}
...
execute if score timer end matches 1 run summon area_effect_cloud 166.05 29.5 -154.88 {Rotation:[-128f,30f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
