...
execute if score timer end matches 1 run summon armor_stand 4 26 -199 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{Damage:123,Unbreakable:1}}],Tags:["end_scene"],Rotation:[-30f,0f],CustomName:"{\"translate\":\"citizen\",\"color\":\"gold\"}",CustomNameVisible:1,NoGravity:1}
execute if score timer end matches 1 run summon armor_stand 6 26 -203 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{Damage:124,Unbreakable:1}}],Tags:["end_scene"],Rotation:[120f,0f],CustomName:"{\"translate\":\"merchant2\",\"color\":\"dark_blue\"}",CustomNameVisible:1,NoGravity:1}
execute if score timer end matches 1 run summon armor_stand 12 26 -195 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{Damage:125,Unbreakable:1}}],Tags:["end_scene"],Rotation:[122f,0f],CustomName:"{\"translate\":\"guard\",\"color\":\"gray\"}",CustomNameVisible:1,NoGravity:1}

#Scene
execute if score timer end matches 1 run gamemode spectator @a[gamemode=adventure]
execute if score timer end matches 1 run summon area_effect_cloud 7 31 -208 {Rotation:[0f,25f],Radius:0.0f,Duration:2147483647,Tags:["cutscenePov"]}
