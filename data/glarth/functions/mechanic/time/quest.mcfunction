...
execute if score quest Stats matches 4 if score garyMode Stats matches ..1 run team modify CurrentTaleN suffix [" ",{"color":"gray","translate":"sidebar.tale.4"}]
execute if score quest Stats matches 4 if score garyMode Stats matches 2.. run team modify CurrentTaleN suffix [" ",{"color":"gray","translate":"sidebar.tale.10"}]
...
execute if score quest Stats matches 4 if score garyMode Stats matches ..1 run team modify ObjectiveN suffix [" ",{"color":"gray","translate":"sidebar.obj.4.1"}]
execute if score quest Stats matches 4 if score garyMode Stats matches ..1 run team modify ObjectiveN2 suffix [" ",{"color":"gray","translate":"sidebar.obj.4.2"}]
execute if score quest Stats matches 4 if score garyMode Stats matches 2.. run team modify ObjectiveN suffix [" ",{"color":"gray","translate":"sidebar.obj.10.1"}]
execute if score quest Stats matches 4 if score garyMode Stats matches 2.. run team modify ObjectiveN2 suffix [" ",{"color":"gray","translate":"sidebar.obj.10.2"}]
