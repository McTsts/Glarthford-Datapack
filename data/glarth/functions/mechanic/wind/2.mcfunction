scoreboard players set millSpeed Animation 20
...
execute unless score lowGraphics Stats matches 1 if score quest Stats matches 1.. as @a[gamemode=adventure] at @s unless score @s dimension matches 1.. run function glarth:mechanic/wind/check_wind
execute unless score lowGraphics Stats matches 1 if score quest Stats matches 1.. as @a[gamemode=spectator] at @s unless score @p[gamemode=adventure] dimension matches 1.. run function glarth:mechanic/wind/check_wind