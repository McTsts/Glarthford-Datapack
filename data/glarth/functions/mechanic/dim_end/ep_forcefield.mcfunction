...
summon minecraft:armor_stand -48.00 89.5 -642.00 {NoGravity:1,Invisible:1,Marker:1,Tags:["endFFgas","forcefield"],Passengers:[{id:"ghast",Tags:["endFFghast","forcefield"],Silent:1b,NoAI:1,NoGravity:1,PersistenceRequired:1b,Invulnerable:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0,show_particles:0b}]},{id:"ghast",Tags:["endFFghast","forcefield"],Silent:1b,NoAI:1,NoGravity:1,PersistenceRequired:1b,Invulnerable:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0,show_particles:0b}]},{id:"ghast",Tags:["endFFghast","forcefield"],Silent:1b,NoAI:1,NoGravity:1,PersistenceRequired:1b,Invulnerable:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0,show_particles:0b}]},{id:"ghast",Tags:["endFFghast","forcefield"],Silent:1b,NoAI:1,NoGravity:1,PersistenceRequired:1b,Invulnerable:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0,show_particles:0b}]}]}
