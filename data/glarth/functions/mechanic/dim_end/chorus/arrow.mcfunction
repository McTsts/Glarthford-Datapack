...
execute at @s positioned ^ ^ ^0.5 run summon item ~ ~-1 ~ {Item:{id:"gray_dye",count:1,components:{"minecraft:custom_name":'{"translate":"item.minecraft.chorus_fruit","italic":false}'}}}
