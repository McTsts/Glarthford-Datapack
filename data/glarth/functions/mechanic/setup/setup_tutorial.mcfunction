...
# Characters
summon armor_stand 71 26 -201 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",count:1},{id:"minecraft:chainmail_chestplate",count:1},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":52,"minecraft:unbreakable":{}}}],Tags:["char","explorer2","sleep"],Rotation:[-65.0f,0.0f],CustomName:'{"translate":"explorer","color":"gold"}',CustomNameVisible:1}
...
summon armor_stand 84 16 -182 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",count:1},{id:"minecraft:chainmail_chestplate",count:1},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":177,"minecraft:unbreakable":{}}}],Tags:["char","gunpowder_warden"],Rotation:[-135.0f,0.0f],CustomName:'{"translate":"gunpowder_warden","color":"dark_gray"}',CustomNameVisible:1}
summon armor_stand 125 18.5 -217 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",count:1},{id:"minecraft:chainmail_chestplate",count:1},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":178,"minecraft:unbreakable":{}}}],Tags:["char","bat","tbcLoc072"],Rotation:[65.0f,0.0f],CustomName:'{"translate":"bat","color":"black"}',CustomNameVisible:1}
summon armor_stand 66 19 -191 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"minecraft:chainmail_leggings",count:1},{id:"minecraft:chainmail_chestplate",count:1},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":179,"minecraft:unbreakable":{}}}],Tags:["char","sorcerer"],Rotation:[-90.0f,0.0f],CustomName:'{"translate":"sorcerer","color":"dark_purple"}',CustomNameVisible:1}

# Decoration
execute unless score lowGraphics Stats matches 1 run summon minecraft:armor_stand 76 24.45 -206 {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":175}}],Invulnerable:1b,Fire:1000s,NoGravity:1,Tags:["campfire","fire"],DisabledSlots:4144959,Invisible:1,Marker:0}
