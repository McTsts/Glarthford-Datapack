...
execute as @e[type=shulker,tag=char_collision,distance=..3] at @s unless entity @e[type=armor_stand,tag=char,tag=!cnoc,distance=..2] run data merge entity @s {Health:0.0f,DeathTime:18s,Pos:[0.0d,0.0d,0.0d]}
