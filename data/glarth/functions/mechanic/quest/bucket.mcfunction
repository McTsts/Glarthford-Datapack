...
execute as @e[tag=bucket_ghast,tag=hurt] at @s as @r[tag=holdBucket,distance=..10] run give @s minecraft:diamond_hoe[custom_name='{"text":"item.bucket_slime","italic":false}',unbreakable={show_in_tooltip:0b},hide_additional_tooltip={}] 1
