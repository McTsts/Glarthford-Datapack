loot replace entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:golden_helmet",components:{"minecraft:custom_model_data":1}}]}] armor.head loot glarth:give/vindicator_skull
