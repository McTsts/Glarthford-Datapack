...
execute as @s[scores={action=1..1}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.1 5 force @a
execute as @s[scores={action=1..1}] at @s run playsound minecraft:entity.enderdragon.hurt block @a ~ ~ ~ 0.5 0
execute as @s[scores={action=11..11}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.1 5 force @a
execute as @s[scores={action=11..11}] at @s run playsound minecraft:entity.enderdragon.hurt block @a ~ ~ ~ 0.5 0
execute as @s[scores={action=21..21}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.1 10 force @a
execute as @s[scores={action=21..21}] at @s run playsound minecraft:entity.enderdragon.hurt block @a ~ ~ ~ 0.5 0
execute as @s[scores={action=27..27}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.1 10 force @a
execute as @s[scores={action=27..27}] at @s run playsound minecraft:entity.enderdragon.hurt block @a ~ ~ ~ 0.5 0
execute as @s[scores={action=33..33}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.1 20 force @a
execute as @s[scores={action=33..33}] at @s run playsound minecraft:entity.enderdragon.hurt block @a ~ ~ ~ 0.5 0
execute as @s[scores={action=35..35}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.1 20 force @a
execute as @s[scores={action=35..35}] at @s run playsound minecraft:entity.enderdragon.hurt block @a ~ ~ ~ 0.5 0
execute as @s[scores={action=40..50}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.1 20 force @a
execute as @s[scores={action=51..60}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.2 30 force @a
execute as @s[scores={action=61..70}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 0.5 50 force @a
execute as @s[scores={action=71..80}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 1 100 force @a
execute as @s[scores={action=81..90}] at @s run particle block red_concrete 70.0 27.5 -156 0.1 0.1 0.1 2 200 force @a
