...
execute if score @s action matches 1171.. unless entity @e[tag=mbBucket] run summon minecraft:armor_stand 3.5 25.6 -200.5 {ArmorItems:[{},{},{},{id:"diamond_hoe",Count:1,tag:{Damage:118}}],Marker:1,Tags:["mbBucket"],NoGravity:1,Invisible:1}
