...
execute @s[score_action_min=2,score_action=2] ~ ~ ~ summon minecraft:item ~ ~ ~ {Item:{id:"paper",Count:1,tag:{display:{LocName:"item.rletter",Lore:["I kidnapped your wife!","I'll kill her at 24:00, meet","me in the sewers -R.R."]}}},CustomName:"Letter",CustomNameVisible:1}
