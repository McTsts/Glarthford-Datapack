...
execute if score timer cedric matches -500 run data merge entity @e[tag=cedric,type=armor_stand,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":120,"minecraft:unbreakable":{}}}],NoGravity:1}
...
execute if score timer cedric matches 1 run summon armor_stand 172 6 -359 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:damage":120,"minecraft:unbreakable":{}}}],Tags:["cedricSceneCedric","cedricScene"],Rotation:[160.0f,0.0f],CustomName:'{"translate":"cedric","color":"blue"}',CustomNameVisible:1}
execute if score timer cedric matches 1 run summon armor_stand 170 6 -359 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:custom_model_data":223,"minecraft:unbreakable":{}}}],Tags:["cedricSceneNecromancer","cedricScene"],Rotation:[-160.0f,0.0f],CustomName:'{"translate":"necromancer2","color":"gold"}',CustomNameVisible:1}
execute if score timer cedric matches 1 run summon armor_stand 176 6 -356 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:custom_model_data":233,"minecraft:unbreakable":{}}}],Tags:["cedricSceneExtra","cedricScene"],Rotation:[20.0f,0.0f],CustomName:'{"translate":"maid","color":"yellow"}',CustomNameVisible:1}
execute if score timer cedric matches 1 run summon armor_stand 180.0 6.00 -352.8 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:custom_model_data":236,"minecraft:unbreakable":{}}}],Tags:["cedricSceneExtra","cedricScene"],Rotation:[60.0f,0.0f],CustomName:'{"translate":"woman","color":"dark_aqua"}',CustomNameVisible:1}
execute if score timer cedric matches 1 run summon armor_stand 168 6 -351.0 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:custom_model_data":235,"minecraft:unbreakable":{}}}],Tags:["cedricSceneExtra","cedricScene"],Rotation:[180.0f,0.0f],CustomName:'{"translate":"castle_guard","color":"gold"}',CustomNameVisible:1}
execute if score timer cedric matches 1 run summon armor_stand 181 6 -347 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:custom_model_data":244,"minecraft:unbreakable":{}}}],Tags:["cedricSceneExtra","cedricScene"],Rotation:[90.0f,0.0f],CustomName:'{"translate":"groundskeeper","color":"#8C5800"}',CustomNameVisible:1}
...
execute if score timer cedric matches 1 run summon armor_stand 95.5 27.00 -243.0 {Invulnerable:1b,Invisible:1b,DisabledSlots:2036499,ArmorItems:[{},{id:"chainmail_leggings",count:1},{id:"chainmail_chestplate",count:1},{id:"minecraft:diamond_hoe",count:1,components:{"minecraft:custom_model_data":223,"minecraft:unbreakable":{}}}],Tags:["char","necromancer","tbcLoc083"],Rotation:[-80.0f,0.0f],CustomName:'{"translate":"necromancer","color":"red"}',CustomNameVisible:1}
...
execute if score timer cedric matches 800 run summon minecraft:skeleton 100.9 25.5 -242.5 {CustomName:'"Dinnerbone"',Team:"noc",NoAI:1,Silent:1b,Invulnerable:1,Tags:["cedricScene","csD"],Passengers:[{id:"armor_stand",Small:1,Invulnerable:1,Invisible:1,Tags:["cedricScene"]}],Rotation:[90.0f,0.0f]}
execute if score timer cedric matches 800 run summon minecraft:skeleton 102.1 25.5 -242.5 {CustomName:'"Dinnerbone"',Team:"noc",NoAI:1,Silent:1b,Invulnerable:1,Tags:["cedricScene","csD"],Passengers:[{id:"armor_stand",Small:1,Invulnerable:1,Invisible:1,Tags:["cedricScene"]}],Rotation:[90.0f,0.0f]}
execute if score timer cedric matches 800 run summon minecraft:skeleton 101.0 25.5 -242.0 {CustomName:'"Dinnerbone"',Team:"noc",NoAI:1,Silent:1b,Invulnerable:1,Tags:["cedricScene","csD"],Passengers:[{id:"armor_stand",Small:1,Invulnerable:1,Invisible:1,Tags:["cedricScene"]}],Rotation:[45.0f,0.0f]}
execute if score timer cedric matches 800 run summon minecraft:skeleton 102.0 25.5 -243.0 {CustomName:'"Dinnerbone"',Team:"noc",NoAI:1,Silent:1b,Invulnerable:1,Tags:["cedricScene","csD"],Passengers:[{id:"armor_stand",Small:1,Invulnerable:1,Invisible:1,Tags:["cedricScene"]}],Rotation:[45.0f,0.0f]}
execute if score timer cedric matches 800 run summon minecraft:skeleton 102.0 25.5 -242.0 {CustomName:'"Dinnerbone"',Team:"noc",NoAI:1,Silent:1b,Invulnerable:1,Tags:["cedricScene","csD"],Passengers:[{id:"armor_stand",Small:1,Invulnerable:1,Invisible:1,Tags:["cedricScene"]}],Rotation:[-45.0f,0.0f]}
execute if score timer cedric matches 800 run summon minecraft:skeleton 101.0 25.5 -243.0 {CustomName:'"Dinnerbone"',Team:"noc",NoAI:1,Silent:1b,Invulnerable:1,Tags:["cedricScene","csD"],Passengers:[{id:"armor_stand",Small:1,Invulnerable:1,Invisible:1,Tags:["cedricScene"]}],Rotation:[-45.0f,0.0f]}
