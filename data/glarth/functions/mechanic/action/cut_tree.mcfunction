...
execute if score @s action matches 30 facing 71 27 -250 run playsound minecraft:block.wood.break neutral @a ~ ~ ~ 3 0.5
execute if score @s action matches 30 facing 71 27 -250 run playsound minecraft:block.wood.break neutral @a ~ ~ ~ 3 0.5
execute if score @s action matches 30 facing 71 27 -250 run playsound minecraft:block.wood.break neutral @a ~ ~ ~ 3 0.5
execute if score @s action matches 30 facing 71 27 -250 run summon minecraft:armor_stand 71 31 -249 {ArmorItems:[{},{},{},{id:"diamond_hoe",count:1,components:{"minecraft:damage":141}}],NoGravity:1,Rotation:[180.0f,0.0f],Tags:["tree1","die"],Invulnerable:1b,DisabledSlots:4144959,Invisible:1}
