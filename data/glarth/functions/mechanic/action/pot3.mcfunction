...
execute as @s[scores={PoT3=99..99}] at @s run summon item ~ ~ ~ {Item:{id:"diamond_hoe",count:1,components:{"minecraft:damage":249,"minecraft:custom_name":'{"translate":"tbc.attack.staff.wind_staff","italic":false}',"minecraft:lore":['""','{"translate":"item.modifiers.tbc","italic":false,"color":"gray"}','[" ",{"translate":"tbc.attack.msg.name.damage","color":"dark_green","italic":false,"with":[{"translate":"tbc.attack.msg.name.damage.low"}]}]','[" ",{"translate":"tbc.attack.msg.name.stun","color":"dark_green","italic":false,"with":[{"translate":"tbc.attack.msg.name.damage.short"}]}]'],"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:hide_additional_tooltip":{}}},Tags:["wind_staff"],Motion:[0.0d,1.0d,0.0d]}
