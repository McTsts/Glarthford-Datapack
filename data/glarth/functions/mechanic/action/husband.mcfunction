scoreboard players add @e[tag=husband2] wife 1
scoreboard players add @e[tag=husband2] wife2 1
execute as @e[tag=husband2,scores={wife=1}] at @s run tp @s 7 26 -212 0 0
execute as @e[tag=husband2,scores={wife=2..101}] at @s run tp @s ~ ~ ~0.1
execute as @e[tag=husband2,scores={wife=102..146}] at @s run tp @s ~ ~ ~ ~4 ~
execute as @e[tag=husband2,scores={wife=147..246}] at @s run tp @s ~ ~ ~-0.1 ~ ~
execute as @e[tag=husband2,scores={wife=247..292}] at @s run tp @s ~ ~ ~ ~4 ~
scoreboard players set @e[tag=husband2,scores={wife=293..}] wife 0
...
scoreboard players set @e[tag=husband2,scores={wife2=16..}] wife2 0