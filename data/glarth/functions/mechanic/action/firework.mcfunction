...
scoreboard players set r Random 5
function glarth:util/random
execute if score n Random matches 1 run data merge entity @e[tag=newFirework,limit=1] {FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;14561830]}]}}}}
execute if score n Random matches 2 run data merge entity @e[tag=newFirework,limit=1] {FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;14587677]}]}}}}
execute if score n Random matches 3 run data merge entity @e[tag=newFirework,limit=1] {FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;15923712]}]}}}}
execute if score n Random matches 4 run data merge entity @e[tag=newFirework,limit=1] {FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;11359824]}]}}}}
execute if score n Random matches 5 run data merge entity @e[tag=newFirework,limit=1] {FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;13922901]}]}}}}
