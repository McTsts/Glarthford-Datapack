...
# Bow
execute as @a[nbt={Inventory:[{id:"minecraft:brown_dye"}]}] run loot give @s loot glarth:give/bows/bow
execute as @a[nbt={Inventory:[{id:"minecraft:brown_dye"}]}] run clear @s brown_dye

execute as @a[nbt={Inventory:[{id:"minecraft:honeycomb"}]}] run loot give @s loot glarth:give/tools/shears
