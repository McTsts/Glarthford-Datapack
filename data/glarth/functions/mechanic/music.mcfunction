...
tellraw @a[score_MusicSet_min=10,score_MusicSet=10] ["",{"text":"[","color":"dark_gray","bold":true},{"text":"TS","color":"gold","bold":true,"obfuscated":true},{"text":"] ","color":"dark_gray","bold":true,"obfuscated":false},{"text":"♪♫ Now playing: ","color":"gray","bold":false},{"text":"Boozy Brewer","color":"gold","underlined":true},{"text":" by ","color":"gray","underlined":false},{"text":"TTEXTT","color":"gold","underlined":true},{"text":" 🎜♬","color":"gray","underlined":false}]
...
scoreboard players set @a[score_MusicSet_min=10,score_MusicSet=10] MusicTime 2640
...
playsound boozy_brewer record @a[score_MusicSet_min=10,score_MusicSet=10] ~ ~ ~ 1000 1
...
execute @a[score_MusicTime=0,tag=MusicRandom] ~ ~ ~ scoreboard players set r Random 10
...
execute @a ~ ~ ~ detect ~ 0 ~ dirt * scoreboard players set @s MusicArea 10
