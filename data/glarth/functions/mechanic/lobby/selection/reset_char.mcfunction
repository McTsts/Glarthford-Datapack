...
data modify block ~ ~ ~ front_text.messages[1] set value '{"color":"dark_gray","clickEvent":{"action":"run_command","value":"function glarth:mechanic/lobby/selection/reset_char"},"translate":"lobby.selection.reset"}'
