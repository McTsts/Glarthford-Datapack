...
execute if score lPlayers Temp matches 1.. run data modify block 164 24 -95 Text2 set value '[{"text":"","color":"blue"},{"entity":"@p[gamemode=adventure,tag=!lSpec,scores={Temp=1}]","nbt":"EnderItems[{Slot:0b}].tag.name","interpret":true}]'
execute if score lPlayers Temp matches 2.. run data modify block 164 24 -95 Text3 set value '[{"text":"","color":"green"},{"entity":"@p[gamemode=adventure,tag=!lSpec,scores={Temp=2}]","nbt":"EnderItems[{Slot:0b}].tag.name","interpret":true}]'
execute if score lPlayers Temp matches 3.. run data modify block 164 24 -95 Text4 set value '[{"text":"","color":"red"},{"entity":"@p[gamemode=adventure,tag=!lSpec,scores={Temp=3}]","nbt":"EnderItems[{Slot:0b}].tag.name","interpret":true}]'