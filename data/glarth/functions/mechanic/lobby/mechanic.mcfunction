...
execute as @e[tag=hurt] at @s if entity @p[distance=..6,gamemode=adventure] as @s[scores={dmg=0..}] at @s run playsound minecraft:ui.button.click player @s ~ ~ ~ 0.5 2
...
execute positioned 185 23 -112 as @a[scores={trade=1..},distance=..10] at @s run playsound minecraft:ui.button.click player @s ~ ~ ~ 0.5 2
...
execute if score game Stats matches 0 as @r[x=192,y=18,z=-112,distance=..5,gamemode=adventure,tag=!lSpec] at @s if block ~ 14 ~ red_terracotta if data entity @s {OnGround:0b} if score x questU matches 1 if score quest Stats matches 0..10 run function glarth:mechanic/start
execute if score game Stats matches 0 as @r[x=192,y=18,z=-112,distance=..5,gamemode=adventure,tag=!lSpec] at @s if block ~ 14 ~ red_terracotta if data entity @s {OnGround:0b} if score x questU matches 1 if score quest Stats matches 11 run function glarth:mechanic/lobby/start_br
execute if score game Stats matches 0 as @r[x=192,y=18,z=-112,distance=..5,gamemode=adventure,tag=!lSpec] at @s if block ~ 14 ~ red_terracotta if data entity @s {OnGround:0b} if score x questU matches 0 run playsound minecraft:error player @s ~ ~ ~ 1 1 1
...
execute unless score lobbyTBC Stats matches 2 run effect give @a minecraft:saturation 3 0 true
execute unless score lobbyTBC Stats matches 2 run effect give @a[scores={lobbyHealth=..19}] minecraft:instant_health 1 0 true
...
execute if score lPlayers Temp matches 1..3 if score quest Stats matches 11 if score difficulty Stats matches 0 run scoreboard players set lPlayers Temp 100
