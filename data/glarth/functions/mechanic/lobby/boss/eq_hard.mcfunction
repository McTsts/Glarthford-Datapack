# Armor
replaceitem entity @a[scores={playerid=1..}] armor.head minecraft:leather_helmet
replaceitem entity @a[scores={playerid=1..}] armor.chest minecraft:leather_chestplate
replaceitem entity @a[scores={playerid=1..}] armor.legs minecraft:leather_leggings
replaceitem entity @a[scores={playerid=1..}] armor.feet minecraft:leather_boots
