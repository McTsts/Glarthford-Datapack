...
execute if score bossRe Stats matches 0.. run setblock 175 24 -114 minecraft:oak_wall_sign[facing=south]{front_text:{messages:[{"clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!lSpec] if score difficulty Stats matches 0 run playsound minecraft:error player @s ~ ~ ~ 1 1"},"text":""},'{"translate":"lobby.boss.redo","bold":true,"clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!lSpec] if score difficulty Stats matches 1.. run function glarth:mechanic/lobby/boss/redo"}}','""','{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=lSpec] run playsound minecraft:error player @s ~ ~ ~ 1 1"}}']}}
execute if score bossRe Stats matches 0.. run setblock 173 25 -114 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['""','{"translate":"lobby.boss.previous","bold":true,"clickEvent":{"action":"run_command","value":"function glarth:mechanic/lobby/boss/previous"}}','""','""']}}
execute if score bossRe Stats matches 0.. run setblock 177 25 -114 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['""','{"translate":"lobby.boss.next","bold":true,"clickEvent":{"action":"run_command","value":"function glarth:mechanic/lobby/boss/next"}}','""','""']}}
