...
execute store success score success2 Temp run data modify storage glarth:main invget.temp2.tag.custom set from storage glarth:main invget.in.tag.custom
