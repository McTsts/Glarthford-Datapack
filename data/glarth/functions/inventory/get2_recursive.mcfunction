...
execute store success score success2 Temp run data modify storage glarth:main invget.temp2.components.minecraft:custom_data.bow set from storage glarth:main invget.in.components.minecraft:custom_data.bow
...
execute if score success Temp matches 1 if data storage glarth:main invget.temp[0] run function glarth:inventory/get2_recursive
