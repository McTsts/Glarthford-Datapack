...
# Ghosts hide
execute if score time Dis matches 0700..2059 if entity @e[type=area_effect_cloud,tag=events,tag=!evGhostsHide] run function glarth:events/event/moves/ghosts
execute if score time Dis matches ..0659 if entity @e[type=area_effect_cloud,tag=events,tag=evGhostsHide] run function glarth:events/event/moves/ghosts_undo
execute if score time Dis matches 2100.. if entity @e[type=area_effect_cloud,tag=events,tag=evGhostsHide] run function glarth:events/event/moves/ghosts_undo
# Zombie burns
execute if score time Dis matches 0730.. if entity @e[type=area_effect_cloud,tag=events,tag=!evZombieBurns] unless score quest Stats matches 7 run function glarth:events/event/burns/zombie
execute if score time Dis matches ..0629 if entity @e[type=area_effect_cloud,tag=events,tag=evZombieBurns] unless score quest Stats matches 7 run function glarth:events/event/burns/zombie_undo
# Zombie dies
execute if score time Dis matches 0800.. if entity @e[type=area_effect_cloud,tag=events,tag=!evZombieDies] unless score quest Stats matches 7 run function glarth:events/event/dies/zombie
execute if score time Dis matches ..0759 if entity @e[type=area_effect_cloud,tag=events,tag=evZombieDies] unless score quest Stats matches 7 run function glarth:events/event/dies/zombie_undo
# Skeleton burns
...
# Guard wakes up
execute if score time Dis matches 1000.. if entity @e[type=area_effect_cloud,tag=events,tag=!evGuardWakes] run function glarth:events/event/wakes/guard
execute if score time Dis matches ..0959 if entity @e[type=area_effect_cloud,tag=events,tag=evGuardWakes] run function glarth:events/event/wakes/guard_undo
# Clock
...
# Apple Lover torch
execute if score time Dis matches 1930.. if entity @e[type=area_effect_cloud,tag=events,tag=!evAppleLoverTorch] unless score quest Stats matches 4 unless score quest Stats matches 7 run function glarth:events/event/torch/apple_lover_raid
execute if score time Dis matches ..1929 if entity @e[type=area_effect_cloud,tag=events,tag=evAppleLoverTorch] unless score quest Stats matches 4 unless score quest Stats matches 7 run function glarth:events/event/torch/apple_lover_raid_undo
# Ts escapes
...
# Dockmaster torch
execute if score time Dis matches 1930.. if entity @e[type=area_effect_cloud,tag=events,tag=!evDockmasterTorch] unless score quest Stats matches 4 unless score quest Stats matches 7 run function glarth:events/event/torch/dockmaster_raid
execute if score time Dis matches ..1929 if entity @e[type=area_effect_cloud,tag=events,tag=evDockmasterTorch] unless score quest Stats matches 4 unless score quest Stats matches 7 run function glarth:events/event/torch/dockmaster_raid_undo
# Druid Scene
