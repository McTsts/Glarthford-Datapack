...
# Dialogue
execute if entity @s[tag=angryPiglin,tag=!b] run function glarth:dialogue/piglin5/lines/angry
execute if entity @s[tag=angryPiglin,tag=!b] as @a[distance=..5,tag=!tip42] run function glarth:mechanic/tip/42
execute if entity @s[tag=!angryPiglin,tag=!b] run function glarth:dialogue/piglin5/lines/generic
execute if entity @s[tag=b,tag=!z] run function glarth:dialogue/piglin5/lines/generic2
execute if entity @s[tag=z] run schedule function glarth:dialogue/piglin5/lines/zombie 5
