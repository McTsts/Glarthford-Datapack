...
execute if entity @e[tag=richard,tag=b] run summon item ~ ~ ~ {Item:{id:"diamond_hoe",Count:1,tag:{Unbreakable:1,HideFlags:63,Damage:40,display:{Name:"{\"translate\":\"item.key\",\"italic\":false}"}}}}
