execute @s[tag=!b] ~ ~ ~ tellraw @a[r=5] ["",{"text":"\n[","color":"dark_gray"},{"translate":"archaeologist","color":"gray"},{"text":"] ","color":"dark_gray"},{"translate":"archaeologist.n","color":"gray"}]
execute @s[tag=!b] ~ ~ ~ playsound archaeologist2 voice @a[r=5] ~ ~ ~ 100 1
