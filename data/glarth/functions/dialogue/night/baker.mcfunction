...
execute @s[score_Success_min=1] ~ ~ ~ tellraw @a[r=5] ["",{"text":"\n[","color":"dark_gray"},{"translate":"baker","color":"red"},{"text":"] ","color":"dark_gray"},{"translate":"baker.n","color":"gray"}]
execute @s[score_Success_min=1] ~ ~ ~ playsound baker2 voice @a[r=5] ~ ~ ~ 100 1
