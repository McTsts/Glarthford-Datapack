...
execute if score wifeCounter Temp matches 1 as @a at @s run playsound wife12 voice @s ~ ~ ~ 1 1 1
...
execute if score wifeCounter Temp matches 2 as @a at @s run playsound wife13 voice @s ~ ~ ~ 1 1 1
...
execute if score wifeCounter Temp matches 3 as @a at @s run playsound wife14 voice @s ~ ~ ~ 1 1 1