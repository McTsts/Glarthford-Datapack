...
execute if entity @a[gamemode=adventure,distance=..10,nbt={Inventory:[{id:"minecraft:diamond_hoe",Slot:103b,components:{"minecraft:custom_model_data":481}}]}] run tag @s remove angryPiglin
# Dialogue
