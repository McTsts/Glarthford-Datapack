...
give @s minecraft:enchanted_golden_apple[lore=['{"translate":"lore.gapple.1","italic":false,"color":"gray"}','{"translate":"lore.gapple.2","italic":false,"color":"gray"}'],hide_additional_tooltip={}]
