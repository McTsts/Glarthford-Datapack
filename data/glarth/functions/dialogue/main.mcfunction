...
execute as @a[tag=func,gamemode=adventure] if score @s diaCooldown matches 1.. run function glarth:dialogue/all
...
execute as @a[tag=func,gamemode=adventure] at @s as @e[tag=char,type=armor_stand,limit=1,sort=nearest] run function glarth:dialogue/all
