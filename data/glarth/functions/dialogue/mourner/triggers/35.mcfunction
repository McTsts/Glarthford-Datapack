...
clear @a player_head{isDogSkull:1}
kill @e[type=item,nbt={Item:{tag:{isDogSkull:1}}}]
setblock -82 25 -208 chest[facing=north,type=right]
setblock -83 25 -208 chest[facing=north,type=left]
summon minecraft:wolf -81.01 27.00 -208.65 {Tame:1,Invulnerable:1,NoAI:1,Tags:["mournerWolf","newAnimal"],Sitting:1b,Rotation:[35f,0f]}
