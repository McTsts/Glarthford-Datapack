...
execute @s[score_Success_min=1] ~ ~ ~ tellraw @a[r=5] ["",{"text":"\n[","color":"dark_gray"},{"translate":"hermit","color":"yellow"},{"text":"] ","color":"dark_gray"},{"translate":"hermit.d","color":"gray"}]
execute @s[score_Success_min=1] ~ ~ ~ playsound hermit1 voice @a[r=5] ~ ~ ~ 100 1
scoreboard players test quest Stats 2
execute @s[score_Success_min=1] ~ ~ ~ tellraw @a[r=5] ["",{"text":"\n[","color":"dark_gray"},{"translate":"hermit","color":"yellow"},{"text":"] ","color":"dark_gray"},{"translate":"hermit.d2","color":"gray"}]
execute @s[score_Success_min=1] ~ ~ ~ playsound hermit3 voice @a[r=5] ~ ~ ~ 100 1
