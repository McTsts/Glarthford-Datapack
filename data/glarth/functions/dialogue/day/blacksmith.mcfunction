execute @s[tag=!c] ~ ~ ~ tellraw @a[r=5] ["",{"text":"\n[","color":"dark_gray"},{"translate":"blacksmith","color":"black"},{"text":"] ","color":"dark_gray"},{"translate":"blacksmith.d","color":"gray"}]
execute @s[tag=!c] ~ ~ ~ playsound blacksmith1 voice @a[r=5] ~ ~ ~ 100 1
execute @s[tag=c] ~ ~ ~ tellraw @a[r=5] ["",{"text":"\n[","color":"dark_gray"},{"translate":"blacksmith","color":"black"},{"text":"] ","color":"dark_gray"},{"translate":"blacksmith.d2","color":"gray"}]
execute @s[tag=c] ~ ~ ~ playsound blacksmith4 voice @a[r=5] ~ ~ ~ 100 1
