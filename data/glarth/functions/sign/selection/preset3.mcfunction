...
execute if score @s signRay matches 1..2 run data modify block ~ ~ ~ front_text.messages[0] set value '{"color":"dark_gray","translate":"lobby.selection.preset.save","with":["3"]}'
execute if score @s signRay matches 3..4 run data modify block ~ ~ ~ front_text.messages[3] set value '{"color":"dark_gray","translate":"lobby.selection.preset.load","with":["3"]}'
