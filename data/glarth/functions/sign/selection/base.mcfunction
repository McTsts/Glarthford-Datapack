...
execute if score @s signRay matches 1..2 run scoreboard players remove @s charBase 1
execute if score @s signRay matches 3..4 run scoreboard players add @s charBase 1
