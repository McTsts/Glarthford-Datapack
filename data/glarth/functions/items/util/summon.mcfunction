...
$execute if data storage glarth:items temp.id if data storage glarth:items temp.count if data storage glarth:items temp.all run function glarth:items/util/summon/id_multi_all with storage glarth:items $(item)
$execute if data storage glarth:items temp.id if data storage glarth:items temp.count unless data storage glarth:items temp.all run function glarth:items/util/summon/id_multi with storage glarth:items $(item)
$execute if data storage glarth:items temp.id unless data storage glarth:items temp.count if data storage glarth:items temp.all run function glarth:items/util/summon/id_all with storage glarth:items $(item)
