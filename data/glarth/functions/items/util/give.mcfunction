...
$execute if data storage glarth:items temp.table if data storage glarth:items temp.count unless data storage glarth:items temp.all run function glarth:items/util/give/table_multi with storage glarth:items $(item)
