...
execute if block ~ ~ ~ iron_door if score door Temp matches 0 run replaceitem entity @e[tag=doorNew,type=armor_stand] armor.head diamond_hoe{CustomModelData:224}
execute if block ~ ~ ~ iron_door if score door Temp matches 1 run replaceitem entity @e[tag=doorNew,type=armor_stand] armor.head diamond_hoe{CustomModelData:355}
execute if block ~ ~ ~ spruce_door run replaceitem entity @e[tag=doorNew,type=armor_stand] armor.head diamond_hoe{CustomModelData:225}
execute if block ~ ~ ~ jungle_door run replaceitem entity @e[tag=doorNew,type=armor_stand] armor.head diamond_hoe{CustomModelData:226}
execute if block ~ ~ ~ acacia_door run replaceitem entity @e[tag=doorNew,type=armor_stand] armor.head diamond_hoe{CustomModelData:227}
