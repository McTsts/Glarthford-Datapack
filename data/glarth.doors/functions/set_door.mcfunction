...
execute if block ~ ~ ~ iron_door if score door Temp matches 0 run item replace entity @e[tag=doorNew,type=armor_stand] armor.head with minecraft:diamond_hoe[custom_model_data=224]
execute if block ~ ~ ~ iron_door if score door Temp matches 1 run item replace entity @e[tag=doorNew,type=armor_stand] armor.head with minecraft:diamond_hoe[custom_model_data=355]
execute if block ~ ~ ~ spruce_door run item replace entity @e[tag=doorNew,type=armor_stand] armor.head with minecraft:diamond_hoe[custom_model_data=225]
execute if block ~ ~ ~ jungle_door run item replace entity @e[tag=doorNew,type=armor_stand] armor.head with minecraft:diamond_hoe[custom_model_data=226]
execute if block ~ ~ ~ acacia_door run item replace entity @e[tag=doorNew,type=armor_stand] armor.head with minecraft:diamond_hoe[custom_model_data=227]
